...
def go_dependencies():
    ...
    go_repository(
        ...
        sum = "h1:WKNUakrNS56vhXaqGNCUFZXxteDxZf/6l6n/XbvUeW8=",
        version = "v0.0.0-20250618122226-6ee70ec687b3",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:VuyIaQ2DnFT3W/sRUW6AA67KZ+YOL4XYcXIS6jQwows=",
        version = "v0.0.0-20250701100252-2620f0ca4eeb",
    )
    go_repository(
