...
def go_dependencies():
    ...
    go_repository(
        ...
        sum = "h1:PYIbA+L1YQEdm8ZbNW8+Hy8xNCrVcXgMhArKr6PhNU8=",
        version = "v0.0.0-20251106090627-b72c34e7f446",
    )
    go_repository(
    ...
    go_repository(
        ...
        importpath = "github.com/theQRL/qrysm/pkg/go-qrl-wallet-encryptor-keystore",
