...
func Test_Proposer_Setting_Cloning(t *testing.T) {
	...
	feeRecipient0, err := common.NewAddressFromString("Q50155530FCE8a85ec7055A5F8b2bE214B3DaeFd3")
	require.NoError(t, err)
	feeRecipient1, err := common.NewAddressFromString("Q6e35733c5af9B61374A128e6F85f553aF09ff89A")
	require.NoError(t, err)
	...
	t.Run("Happy Path Cloning", func(t *testing.T) {
		...
		newFeeRecipient, err := common.NewAddressFromString("Q44455530FCE8a85ec7055A5F8b2bE214B3DaeFd3")
		require.NoError(t, err)
		...
		require.Equal(t, "Q50155530FCE8a85ec7055A5F8b2bE214B3DaeFd3", coption.FeeRecipientConfig.FeeRecipient.Hex())
	})
