...
// TODO(rgeraldes24): used for testnet config comparison with upstream
/*
...
func compareConfigs(t *testing.T, expected, actual *params.BeaconChainConfig) {
	...
	require.DeepEqual(t, expected.EpochsPerZond1VotingPeriod, actual.EpochsPerZond1VotingPeriod)
	...
	require.DeepEqual(t, expected.DilithiumPubkeyLength, actual.DilithiumPubkeyLength)
