...
func ConfigToYaml(cfg *BeaconChainConfig) []byte {
	lines := []string{
		...
		fmt.Sprintf("SECONDS_PER_ZOND1_BLOCK: %d", cfg.SecondsPerZOND1Block),
		fmt.Sprintf("ZOND1_FOLLOW_DISTANCE: %d", cfg.Zond1FollowDistance),
		fmt.Sprintf("EPOCHS_PER_ZOND1_VOTING_PERIOD: %d", cfg.EpochsPerZond1VotingPeriod),
