...
func testFieldParametersMatchConfig(t *testing.T) {
	...
	require.Equal(t, uint64(params.BeaconConfig().SlotsPerEpoch.Mul(uint64(params.BeaconConfig().EpochsPerZond1VotingPeriod))), uint64(fieldparams.Zond1DataVotesLength))
