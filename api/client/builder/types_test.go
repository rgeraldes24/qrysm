...
func TestMarshalBlindedBeaconBlockBodyBellatrix(t *testing.T) {
	...
	require.NoError(t, err)
	b, err := shared.BlindedBeaconBlockBellatrixFromConsensus(&zond.BlindedBeaconBlockBellatrix{
		Slot:          1,
		ProposerIndex: 1,
		ParentRoot:    ezDecode(t, "0xcf8e0d4e9587369b2301d0790347320302cc0943d5a1884560367e8208d920f2"),
		StateRoot:     ezDecode(t, "0xcf8e0d4e9587369b2301d0790347320302cc0943d5a1884560367e8208d920f2"),
...
func TestMarshalBlindedBeaconBlockBodyCapella(t *testing.T) {
	...
	require.NoError(t, err)
	b, err := shared.BlindedBeaconBlockCapellaFromConsensus(&zond.BlindedBeaconBlockCapella{
		Slot:          1,
		ProposerIndex: 1,
		ParentRoot:    ezDecode(t, "0xcf8e0d4e9587369b2301d0790347320302cc0943d5a1884560367e8208d920f2"),
		StateRoot:     ezDecode(t, "0xcf8e0d4e9587369b2301d0790347320302cc0943d5a1884560367e8208d920f2"),
