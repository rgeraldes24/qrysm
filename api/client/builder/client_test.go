...
func TestClient_GetHeader(t *testing.T) {
	ctx := context.Background()
	expectedPath := "/zond/v1/builder/header/23/0xcf8e0d4e9587369b2301d0790347320302cc0943d5a1884560367e8208d920f2/0x93247f2209abcacf57b75a51dafae777f9dd38bc7053d1af526f220a7489a6d3a2753e5f3e8b1cfe39b56f43611df74a"
...
func testSignedBlindedBeaconBlockAndBlobsDeneb(t *testing.T) *zond.SignedBlindedBeaconBlockAndBlobsDeneb {
	basebytes, err := shared.Uint256ToSSZBytes("14074904626401341155369551180448584754667373453244490859944217516317499064576")
	if err != nil {
		log.Error(err)
	}
	return &zond.SignedBlindedBeaconBlockAndBlobsDeneb{
		...
		SignedBlindedBlobSidecars: []*zond.SignedBlindedBlobSidecar{
			{
				Message: &zond.BlindedBlobSidecar{
