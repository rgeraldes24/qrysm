...
var file_proto_testing_test_proto_rawDesc = string([]byte{
...
var (
	...
	file_proto_testing_test_proto_rawDescData []byte
)

func file_proto_testing_test_proto_rawDescGZIP() []byte {
	file_proto_testing_test_proto_rawDescOnce.Do(func() {
		file_proto_testing_test_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_proto_testing_test_proto_rawDesc), len(file_proto_testing_test_proto_rawDesc)))
	})
...
func file_proto_testing_test_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_proto_testing_test_proto_rawDesc), len(file_proto_testing_test_proto_rawDesc)),
			NumEnums:      1,
			NumMessages:   7,
			NumExtensions: 2,
			NumServices:   0,
