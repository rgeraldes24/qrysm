...
// Hash: 803988a148ce490774dffa8a309bbcdf874c8161dcfc13ace363a57f546f1ccb
package v1
...
func (d *Deposit) UnmarshalSSZ(buf []byte) error {
	...
	if err = d.Data.UnmarshalSSZ(buf[1056:8315]); err != nil {
		return err
	}
...
func (b *BeaconBlockBodyCapella) MarshalSSZTo(buf []byte) (dst []byte, err error) {
	...
	// Offset (10) 'MlDsa_87ToExecutionChanges'
	dst = ssz.WriteOffset(dst, offset)
	offset += len(b.MlDsa_87ToExecutionChanges) * 7247
	...
	// Field (10) 'MlDsa_87ToExecutionChanges'
	if size := len(b.MlDsa_87ToExecutionChanges); size > 16 {
		err = ssz.ErrListTooBigFn("--.MlDsa_87ToExecutionChanges", size, 16)
		return
	}
	for ii := 0; ii < len(b.MlDsa_87ToExecutionChanges); ii++ {
		if dst, err = b.MlDsa_87ToExecutionChanges[ii].MarshalSSZTo(dst); err != nil {
			return
		}
	}
...
func (b *BeaconBlockBodyCapella) UnmarshalSSZ(buf []byte) error {
	...
	// Field (10) 'MlDsa_87ToExecutionChanges'
	{
		...
		b.MlDsa_87ToExecutionChanges = make([]*SignedMLDSA87ToExecutionChange, num)
		for ii := 0; ii < num; ii++ {
			if b.MlDsa_87ToExecutionChanges[ii] == nil {
				b.MlDsa_87ToExecutionChanges[ii] = new(SignedMLDSA87ToExecutionChange)
			}
			if err = b.MlDsa_87ToExecutionChanges[ii].UnmarshalSSZ(buf[ii*7247 : (ii+1)*7247]); err != nil {
				return err
			}
		}
	}
...
func (b *BeaconBlockBodyCapella) SizeSSZ() (size int) {
	...
	// Field (10) 'MlDsa_87ToExecutionChanges'
	size += len(b.MlDsa_87ToExecutionChanges) * 7247
...
func (b *BeaconBlockBodyCapella) HashTreeRootWith(hh *ssz.Hasher) (err error) {
	...
	{
		subIndx := hh.Index()
		num := uint64(len(b.MlDsa_87ToExecutionChanges))
		if num > 16 {
			err = ssz.ErrIncorrectListSize
			return
		}
		for _, elem := range b.MlDsa_87ToExecutionChanges {
			if err = elem.HashTreeRootWith(hh); err != nil {
				return
			}
		}
...
func (d *Deposit_Data) UnmarshalSSZ(buf []byte) error {
	...
	if cap(d.Signature) == 0 {
		d.Signature = make([]byte, 0, len(buf[2632:7259]))
	}
	d.Signature = append(d.Signature, buf[2632:7259]...)
