...
// Hash: f8c3432d568c7ece33b08e7aead4934eb022b7ad64be54a8239fc1fe5ae6da74
package v1
...
func (s *SyncAggregate) UnmarshalSSZ(buf []byte) error {
	...
	if cap(s.SyncCommitteeSignature) == 0 {
		s.SyncCommitteeSignature = make([]byte, 0, len(buf[2:73522]))
	}
	s.SyncCommitteeSignature = append(s.SyncCommitteeSignature, buf[2:73522]...)
...
func (v *Validator) UnmarshalSSZ(buf []byte) error {
	...
	// Field (4) 'ActivationEligibilityEpoch'
	v.ActivationEligibilityEpoch = github_com_theQRL_qrysm_v4_consensus_types_primitives.Epoch(ssz.UnmarshallUint64(buf[89:97]))

	// Field (5) 'ActivationEpoch'
	v.ActivationEpoch = github_com_theQRL_qrysm_v4_consensus_types_primitives.Epoch(ssz.UnmarshallUint64(buf[97:105]))

	// Field (6) 'ExitEpoch'
	v.ExitEpoch = github_com_theQRL_qrysm_v4_consensus_types_primitives.Epoch(ssz.UnmarshallUint64(buf[105:113]))

	// Field (7) 'WithdrawableEpoch'
	v.WithdrawableEpoch = github_com_theQRL_qrysm_v4_consensus_types_primitives.Epoch(ssz.UnmarshallUint64(buf[113:121]))
