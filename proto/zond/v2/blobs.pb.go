...
// 	protoc        v4.23.3
// source: proto/zond/v2/blobs.proto
...
func (x *BlobSidecars) Reset() {
	*x = BlobSidecars{}
	if protoimpl.UnsafeEnabled {
		mi := &file_proto_zond_v2_blobs_proto_msgTypes[0]
...
func (*BlobSidecars) Descriptor() ([]byte, []int) {
	return file_proto_zond_v2_blobs_proto_rawDescGZIP(), []int{0}
}
...
type BlobSidecar struct {
	...
	ProposerIndex   github_com_theQRL_qrysm_v4_consensus_types_primitives.ValidatorIndex `protobuf:"varint,5,opt,name=proposer_index,json=proposerIndex,proto3" json:"proposer_index,omitempty" cast-type:"github.com/theQRL/qrysm/v4/consensus-types/primitives.ValidatorIndex"`
...
func (x *BlobSidecar) Reset() {
	*x = BlobSidecar{}
	if protoimpl.UnsafeEnabled {
		mi := &file_proto_zond_v2_blobs_proto_msgTypes[1]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*BlobSidecar) Descriptor() ([]byte, []int) {
	return file_proto_zond_v2_blobs_proto_rawDescGZIP(), []int{1}
}
...
func (x *BlobSidecar) GetSlot() github_com_theQRL_qrysm_v4_consensus_types_primitives.Slot {
	if x != nil {
		return x.Slot
	}
...
func (x *BlobSidecar) GetProposerIndex() github_com_theQRL_qrysm_v4_consensus_types_primitives.ValidatorIndex {
	if x != nil {
...
func (x *SignedBlobSidecar) Reset() {
	*x = SignedBlobSidecar{}
	if protoimpl.UnsafeEnabled {
		mi := &file_proto_zond_v2_blobs_proto_msgTypes[2]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*SignedBlobSidecar) Descriptor() ([]byte, []int) {
	return file_proto_zond_v2_blobs_proto_rawDescGZIP(), []int{2}
}
...
func (x *BlobIdentifier) Reset() {
	*x = BlobIdentifier{}
	if protoimpl.UnsafeEnabled {
		mi := &file_proto_zond_v2_blobs_proto_msgTypes[3]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*BlobIdentifier) Descriptor() ([]byte, []int) {
	return file_proto_zond_v2_blobs_proto_rawDescGZIP(), []int{3}
}
...
func (x *SignedBlindedBlobSidecar) Reset() {
	*x = SignedBlindedBlobSidecar{}
	if protoimpl.UnsafeEnabled {
		mi := &file_proto_zond_v2_blobs_proto_msgTypes[4]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*SignedBlindedBlobSidecar) Descriptor() ([]byte, []int) {
	return file_proto_zond_v2_blobs_proto_rawDescGZIP(), []int{4}
}
...
func (x *BlindedBlobSidecar) Reset() {
	*x = BlindedBlobSidecar{}
	if protoimpl.UnsafeEnabled {
		mi := &file_proto_zond_v2_blobs_proto_msgTypes[5]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*BlindedBlobSidecar) Descriptor() ([]byte, []int) {
	return file_proto_zond_v2_blobs_proto_rawDescGZIP(), []int{5}
}
...
func (x *BlindedBlobSidecar) GetSlot() github_com_theQRL_qrysm_v4_consensus_types_primitives.Slot {
	if x != nil {
		return x.Slot
	}
	return github_com_theQRL_qrysm_v4_consensus_types_primitives.Slot(0)
...
func (x *BlindedBlobSidecar) GetProposerIndex() github_com_theQRL_qrysm_v4_consensus_types_primitives.ValidatorIndex {
	if x != nil {
		return x.ProposerIndex
	}
	return github_com_theQRL_qrysm_v4_consensus_types_primitives.ValidatorIndex(0)
...
var File_proto_zond_v2_blobs_proto protoreflect.FileDescriptor

var file_proto_zond_v2_blobs_proto_rawDesc = []byte{
	,
	...
	0x05, 0x69, 0x6e, 0x64, 0x65, 0x78, 0x12, 0x52, 0x0a, 0x04, 0x73, 0x6c, 0x6f, 0x74, 0x18, 0x03,
	...
	0x6c, 0x6f, 0x63, 0x6b, 0x50, 0x61, 0x72, 0x65, 0x6e, 0x74, 0x52, 0x6f, 0x6f, 0x74, 0x12, 0x6f,
	...
	0x1e, 0x0a, 0x04, 0x62, 0x6c, 0x6f, 0x62, 0x18, 0x06, 0x20, 0x01, 0x28, 0x0c, 0x42, 0x0a, 0x8a,
	...
	,
	...
	0x61, 0x74, 0x75, 0x72, 0x65, 0x22, 0x4d, 0x0a, 0x0e, 0x42, 0x6c, 0x6f, 0x62, 0x49, 0x64, 0x65,
	...
	0x6e, 0x64, 0x65, 0x78, 0x22, 0x7e, 0x0a, 0x18, 0x53, 0x69, 0x67, 0x6e, 0x65, 0x64, 0x42, 0x6c,
	...
	0x74, 0x75, 0x72, 0x65, 0x22, 0xc3, 0x03, 0x0a, 0x12, 0x42, 0x6c, 0x69, 0x6e, 0x64, 0x65, 0x64,
	...
	0x04, 0x52, 0x05, 0x69, 0x6e, 0x64, 0x65, 0x78, 0x12, 0x52, 0x0a, 0x04, 0x73, 0x6c, 0x6f, 0x74,
	...
	0x65, 0x78, 0x18, 0x05, 0x20, 0x01, 0x28, 0x04, 0x42, 0x48, 0x82, 0xb5, 0x18, 0x44, 0x67, 0x69,
	...
	0x78, 0x12, 0x23, 0x0a, 0x09, 0x62, 0x6c, 0x6f, 0x62, 0x5f, 0x72, 0x6f, 0x6f, 0x74, 0x18, 0x06,
	0x20, 0x01, 0x28, 0x0c, 0x42, 0x06, 0x8a, 0xb5, 0x18, 0x02, 0x33, 0x32, 0x52, 0x08, 0x62, 0x6c,
	0x6f, 0x62, 0x52, 0x6f, 0x6f, 0x74, 0x12, 0x2d, 0x0a, 0x0e, 0x6b, 0x7a, 0x67, 0x5f, 0x63, 0x6f,
	...
	0x52, 0x08, 0x6b, 0x7a, 0x67, 0x50, 0x72, 0x6f, 0x6f, 0x66, 0x42, 0x73, 0x0a, 0x12, 0x6f, 0x72,
	0x67, 0x2e, 0x74, 0x68, 0x65, 0x71, 0x72, 0x6c, 0x2e, 0x7a, 0x6f, 0x6e, 0x64, 0x2e, 0x76, 0x32,
	0x42, 0x0a, 0x42, 0x6c, 0x6f, 0x62, 0x73, 0x50, 0x72, 0x6f, 0x74, 0x6f, 0x50, 0x01, 0x5a, 0x2d,
...
var (
	file_proto_zond_v2_blobs_proto_rawDescOnce sync.Once
	file_proto_zond_v2_blobs_proto_rawDescData = file_proto_zond_v2_blobs_proto_rawDesc
)

func file_proto_zond_v2_blobs_proto_rawDescGZIP() []byte {
	file_proto_zond_v2_blobs_proto_rawDescOnce.Do(func() {
		file_proto_zond_v2_blobs_proto_rawDescData = protoimpl.X.CompressGZIP(file_proto_zond_v2_blobs_proto_rawDescData)
	})
	return file_proto_zond_v2_blobs_proto_rawDescData
}

var file_proto_zond_v2_blobs_proto_msgTypes = make([]protoimpl.MessageInfo, 6)
var file_proto_zond_v2_blobs_proto_goTypes = []interface{}{
	(*BlobSidecars)(nil),             // 0: theqrl.zond.v2.BlobSidecars
	(*BlobSidecar)(nil),              // 1: theqrl.zond.v2.BlobSidecar
	(*SignedBlobSidecar)(nil),        // 2: theqrl.zond.v2.SignedBlobSidecar
	(*BlobIdentifier)(nil),           // 3: theqrl.zond.v2.BlobIdentifier
	(*SignedBlindedBlobSidecar)(nil), // 4: theqrl.zond.v2.SignedBlindedBlobSidecar
	(*BlindedBlobSidecar)(nil),       // 5: theqrl.zond.v2.BlindedBlobSidecar
}
var file_proto_zond_v2_blobs_proto_depIdxs = []int32{
	1, // 0: theqrl.zond.v2.BlobSidecars.sidecars:type_name -> theqrl.zond.v2.BlobSidecar
	1, // 1: theqrl.zond.v2.SignedBlobSidecar.message:type_name -> theqrl.zond.v2.BlobSidecar
	5, // 2: theqrl.zond.v2.SignedBlindedBlobSidecar.message:type_name -> theqrl.zond.v2.BlindedBlobSidecar
...
func init() { file_proto_zond_v2_blobs_proto_init() }
func file_proto_zond_v2_blobs_proto_init() {
	if File_proto_zond_v2_blobs_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_proto_zond_v2_blobs_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_proto_zond_v2_blobs_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
		...
		file_proto_zond_v2_blobs_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
		...
		file_proto_zond_v2_blobs_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
		...
		file_proto_zond_v2_blobs_proto_msgTypes[4].Exporter = func(v interface{}, i int) interface{} {
		...
		file_proto_zond_v2_blobs_proto_msgTypes[5].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_proto_zond_v2_blobs_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   6,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_proto_zond_v2_blobs_proto_goTypes,
		DependencyIndexes: file_proto_zond_v2_blobs_proto_depIdxs,
		MessageInfos:      file_proto_zond_v2_blobs_proto_msgTypes,
	}.Build()
	File_proto_zond_v2_blobs_proto = out.File
	file_proto_zond_v2_blobs_proto_rawDesc = nil
	file_proto_zond_v2_blobs_proto_goTypes = nil
	file_proto_zond_v2_blobs_proto_depIdxs = nil
}
