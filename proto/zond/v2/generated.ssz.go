...
// Hash: 9b9aa7fda6f4f7c7df5afd0bc35c479ba6effc67ef5b539d51bfdbf897f7e388
package zond
...
func (b *BeaconBlockBodyAltair) UnmarshalSSZ(buf []byte) error {
	...
	if err = b.SyncAggregate.UnmarshalSSZ(buf[220:73742]); err != nil {
		return err
	}
...
func (b *BeaconBlockBodyBellatrix) UnmarshalSSZ(buf []byte) error {
	...
	if err = b.SyncAggregate.UnmarshalSSZ(buf[4719:78241]); err != nil {
		return err
	}

	// Offset (9) 'ExecutionPayload'
	if o9 = ssz.ReadOffset(buf[78241:78245]); o9 > size || o7 > o9 {
		return ssz.ErrOffset
	}
...
func (b *BeaconBlockBodyCapella) UnmarshalSSZ(buf []byte) error {
	...
	// Offset (10) 'DilithiumToExecutionChanges'
	if o10 = ssz.ReadOffset(buf[78245:78249]); o10 > size || o9 > o10 {
		return ssz.ErrOffset
	}
...
func (b *BlindedBeaconBlockBodyDeneb) UnmarshalSSZ(buf []byte) error {
	...
	// Offset (9) 'ExecutionPayloadHeader'
	if o9 = ssz.ReadOffset(buf[73742:73746]); o9 > size || o7 > o9 {
		return ssz.ErrOffset
	}

	// Offset (10) 'DilithiumToExecutionChanges'
	if o10 = ssz.ReadOffset(buf[73746:73750]); o10 > size || o9 > o10 {
		return ssz.ErrOffset
	}

	// Offset (11) 'BlobKzgCommitments'
	if o11 = ssz.ReadOffset(buf[73750:73754]); o11 > size || o10 > o11 {
		return ssz.ErrOffset
	}
...
func (b *BeaconBlockBodyDeneb) UnmarshalSSZ(buf []byte) error {
	...
	// Offset (11) 'BlobKzgCommitments'
	if o11 = ssz.ReadOffset(buf[78249:78253]); o11 > size || o10 > o11 {
		return ssz.ErrOffset
	}
