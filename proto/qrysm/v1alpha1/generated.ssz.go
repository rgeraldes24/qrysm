...
// Hash: b5b5ba70feb05228905954b9ef9aa177d69a97b4724c8ce917d275096726e2d0
package zond
...
func (b *BeaconState) UnmarshalSSZ(buf []byte) error {
	...
	if err = b.CurrentSyncCommittee.UnmarshalSSZ(buf[2687381:2728853]); err != nil {
		return err
	}
	...
	if err = b.NextSyncCommittee.UnmarshalSSZ(buf[2728853:2770325]); err != nil {
		return err
	}

	// Offset (24) 'LatestExecutionPayloadHeader'
	if o24 = ssz.ReadOffset(buf[2770325:2770329]); o24 > size || o21 > o24 {
		return ssz.ErrOffset
	}

	// Field (25) 'NextWithdrawalIndex'
	b.NextWithdrawalIndex = ssz.UnmarshallUint64(buf[2770329:2770337])

	// Field (26) 'NextWithdrawalValidatorIndex'
	b.NextWithdrawalValidatorIndex = github_com_theQRL_qrysm_v4_consensus_types_primitives.ValidatorIndex(ssz.UnmarshallUint64(buf[2770337:2770345]))

	// Offset (27) 'HistoricalSummaries'
	if o27 = ssz.ReadOffset(buf[2770345:2770349]); o27 > size || o24 > o27 {
		return ssz.ErrOffset
	}
...
func (s *SyncCommitteeContribution) MarshalSSZTo(buf []byte) (dst []byte, err error) {
	...
	if size := len(s.ParticipationBits); size != 2 {
		err = ssz.ErrBytesLengthFn("--.ParticipationBits", size, 2)
		return
	}
	...
	if size := len(s.Signatures); size > 16 {
		err = ssz.ErrListTooBigFn("--.Signatures", size, 16)
		return
	}
...
func (s *SyncCommitteeContribution) UnmarshalSSZ(buf []byte) error {
	...
	if cap(s.ParticipationBits) == 0 {
		s.ParticipationBits = make([]byte, 0, len(buf[48:50]))
	}
	s.ParticipationBits = append(s.ParticipationBits, buf[48:50]...)
