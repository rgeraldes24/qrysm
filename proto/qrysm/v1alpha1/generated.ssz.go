...
// Hash: 2603f71e466fac75b2bc961203e5bb21a1fdf86a1d17ea77604b7c80f0050b61
package zond
...
func (a *Attestation) MarshalSSZTo(buf []byte) (dst []byte, err error) {
	...
	// Offset (3) 'SignaturesIdxToParticipationIdx'
	dst = ssz.WriteOffset(dst, offset)
	offset += len(a.SignaturesIdxToParticipationIdx) * 8
	...
	// Field (3) 'SignaturesIdxToParticipationIdx'
	if size := len(a.SignaturesIdxToParticipationIdx); size > 2048 {
		err = ssz.ErrListTooBigFn("--.SignaturesIdxToParticipationIdx", size, 2048)
		return
	}
	for ii := 0; ii < len(a.SignaturesIdxToParticipationIdx); ii++ {
		dst = ssz.MarshalUint64(dst, a.SignaturesIdxToParticipationIdx[ii])
	}
...
func (a *Attestation) UnmarshalSSZ(buf []byte) error {
	...
	// Offset (3) 'SignaturesIdxToParticipationIdx'
	if o3 = ssz.ReadOffset(buf[136:140]); o3 > size || o2 > o3 {
		return ssz.ErrOffset
	}
	...
	// Field (3) 'SignaturesIdxToParticipationIdx'
	{
		...
		a.SignaturesIdxToParticipationIdx = ssz.ExtendUint64(a.SignaturesIdxToParticipationIdx, num)
		for ii := 0; ii < num; ii++ {
			a.SignaturesIdxToParticipationIdx[ii] = ssz.UnmarshallUint64(buf[ii*8 : (ii+1)*8])
		}
	}
	return err
}
...
func (a *Attestation) SizeSSZ() (size int) {
	...
	// Field (3) 'SignaturesIdxToParticipationIdx'
	size += len(a.SignaturesIdxToParticipationIdx) * 8
...
func (a *Attestation) HashTreeRootWith(hh *ssz.Hasher) (err error) {
	...
	// Field (2) 'Signatures'
	{
		...
		if ssz.EnableVectorizedHTR {
			hh.MerkleizeWithMixinVectorizedHTR(subIndx, numItems, ssz.CalculateLimit(2048, numItems, 0))
		} else {
			hh.MerkleizeWithMixin(subIndx, numItems, ssz.CalculateLimit(2048, numItems, 0))
		}
	}
	...
	// Field (3) 'SignaturesIdxToParticipationIdx'
	{
		...
		subIndx := hh.Index()
		for _, i := range a.SignaturesIdxToParticipationIdx {
			hh.AppendUint64(i)
		}
		hh.FillUpTo32()

		numItems := uint64(len(a.SignaturesIdxToParticipationIdx))
		if ssz.EnableVectorizedHTR {
...
func (a *AttestationData) UnmarshalSSZ(buf []byte) error {
	...
	// Field (1) 'CommitteeIndex'
	a.CommitteeIndex = github_com_theQRL_qrysm_v4_consensus_types_primitives.CommitteeIndex(ssz.UnmarshallUint64(buf[8:16]))
...
func (p *ProposerSlashing) UnmarshalSSZ(buf []byte) error {
	...
	if err = p.Header_1.UnmarshalSSZ(buf[0:4707]); err != nil {
		return err
	}
	...
	if err = p.Header_2.UnmarshalSSZ(buf[4707:9414]); err != nil {
		return err
	}
...
func (i *IndexedAttestation) MarshalSSZTo(buf []byte) (dst []byte, err error) {
	...
	// Field (2) 'Signatures'
	if size := len(i.Signatures); size > 2048 {
		err = ssz.ErrListTooBigFn("--.Signatures", size, 2048)
		return
	}
...
func (s *SyncAggregate) MarshalSSZTo(buf []byte) (dst []byte, err error) {
	...
	// Offset (2) 'SignaturesIdxToCommitteeIdx'
	dst = ssz.WriteOffset(dst, offset)
	offset += len(s.SignaturesIdxToCommitteeIdx) * 8

	// Field (1) 'SyncCommitteeSignatures'
	if size := len(s.SyncCommitteeSignatures); size > 512 {
		err = ssz.ErrListTooBigFn("--.SyncCommitteeSignatures", size, 512)
		return
	}
	...
	// Field (2) 'SignaturesIdxToCommitteeIdx'
	if size := len(s.SignaturesIdxToCommitteeIdx); size > 2048 {
		err = ssz.ErrListTooBigFn("--.SignaturesIdxToCommitteeIdx", size, 2048)
		return
	}
	for ii := 0; ii < len(s.SignaturesIdxToCommitteeIdx); ii++ {
		dst = ssz.MarshalUint64(dst, s.SignaturesIdxToCommitteeIdx[ii])
	}
...
func (s *SyncAggregate) UnmarshalSSZ(buf []byte) error {
	...
	// Offset (2) 'SignaturesIdxToCommitteeIdx'
	if o2 = ssz.ReadOffset(buf[68:72]); o2 > size || o1 > o2 {
		return ssz.ErrOffset
	}
	...
	{
		buf = tail[o1:o2]
		num, err := ssz.DivideInt2(len(buf), 4595, 512)
		if err != nil {
			return err
		}
	...
	// Field (2) 'SignaturesIdxToCommitteeIdx'
	{
		...
		s.SignaturesIdxToCommitteeIdx = ssz.ExtendUint64(s.SignaturesIdxToCommitteeIdx, num)
		for ii := 0; ii < num; ii++ {
			s.SignaturesIdxToCommitteeIdx[ii] = ssz.UnmarshallUint64(buf[ii*8 : (ii+1)*8])
		}
	}
	return err
}
...
func (s *SyncAggregate) SizeSSZ() (size int) {
	...
	// Field (2) 'SignaturesIdxToCommitteeIdx'
	size += len(s.SignaturesIdxToCommitteeIdx) * 8
...
func (s *SyncAggregate) HashTreeRootWith(hh *ssz.Hasher) (err error) {
	...
	// Field (1) 'SyncCommitteeSignatures'
	{
		...
		if ssz.EnableVectorizedHTR {
			hh.MerkleizeWithMixinVectorizedHTR(subIndx, numItems, ssz.CalculateLimit(512, numItems, 0))
		} else {
			hh.MerkleizeWithMixin(subIndx, numItems, ssz.CalculateLimit(512, numItems, 0))
		}
	}
	...
	// Field (2) 'SignaturesIdxToCommitteeIdx'
	{
		...
		subIndx := hh.Index()
		for _, i := range s.SignaturesIdxToCommitteeIdx {
			hh.AppendUint64(i)
		}
		hh.FillUpTo32()

		numItems := uint64(len(s.SignaturesIdxToCommitteeIdx))
		if ssz.EnableVectorizedHTR {
			hh.MerkleizeWithMixinVectorizedHTR(subIndx, numItems, ssz.CalculateLimit(2048, numItems, 8))
		} else {
			hh.MerkleizeWithMixin(subIndx, numItems, ssz.CalculateLimit(2048, numItems, 8))
...
func (s *SignedValidatorRegistrationV1) UnmarshalSSZ(buf []byte) error {
	...
	// Field (1) 'Signature'
	if cap(s.Signature) == 0 {
		s.Signature = make([]byte, 0, len(buf[2628:7223]))
	}
	s.Signature = append(s.Signature, buf[2628:7223]...)
...
func (b *BeaconState) MarshalSSZTo(buf []byte) (dst []byte, err error) {
	...
	// Offset (9) 'Zond1DataVotes'
	dst = ssz.WriteOffset(dst, offset)
	offset += len(b.Zond1DataVotes) * 72

	// Field (10) 'Zond1DepositIndex'
	dst = ssz.MarshalUint64(dst, b.Zond1DepositIndex)
	...
	// Field (9) 'Zond1DataVotes'
	if size := len(b.Zond1DataVotes); size > 2048 {
		err = ssz.ErrListTooBigFn("--.Zond1DataVotes", size, 2048)
		return
	}
	for ii := 0; ii < len(b.Zond1DataVotes); ii++ {
		if dst, err = b.Zond1DataVotes[ii].MarshalSSZTo(dst); err != nil {
			return
		}
	}
...
func (b *BeaconState) UnmarshalSSZ(buf []byte) error {
	...
	if err = b.Zond1Data.UnmarshalSSZ(buf[524468:524540]); err != nil {
		return err
	}
	...
	// Field (10) 'Zond1DepositIndex'
	b.Zond1DepositIndex = ssz.UnmarshallUint64(buf[524544:524552])
	...
	if err = b.CurrentSyncCommittee.UnmarshalSSZ(buf[2687381:4014485]); err != nil {
		return err
	}
	...
	if err = b.NextSyncCommittee.UnmarshalSSZ(buf[4014485:5341589]); err != nil {
		return err
	}

	// Offset (24) 'LatestExecutionPayloadHeader'
	if o24 = ssz.ReadOffset(buf[5341589:5341593]); o24 > size || o21 > o24 {
		return ssz.ErrOffset
	}

	// Field (25) 'NextWithdrawalIndex'
	b.NextWithdrawalIndex = ssz.UnmarshallUint64(buf[5341593:5341601])

	// Field (26) 'NextWithdrawalValidatorIndex'
	b.NextWithdrawalValidatorIndex = github_com_theQRL_qrysm_v4_consensus_types_primitives.ValidatorIndex(ssz.UnmarshallUint64(buf[5341601:5341609]))

	// Offset (27) 'HistoricalSummaries'
	if o27 = ssz.ReadOffset(buf[5341609:5341613]); o27 > size || o24 > o27 {
		return ssz.ErrOffset
	}
	...
	// Field (9) 'Zond1DataVotes'
	{
		...
		b.Zond1DataVotes = make([]*Zond1Data, num)
		for ii := 0; ii < num; ii++ {
			if b.Zond1DataVotes[ii] == nil {
				b.Zond1DataVotes[ii] = new(Zond1Data)
			}
			if err = b.Zond1DataVotes[ii].UnmarshalSSZ(buf[ii*72 : (ii+1)*72]); err != nil {
				return err
			}
		}
	}
...
func (b *BeaconState) HashTreeRootWith(hh *ssz.Hasher) (err error) {
	...
	{
		subIndx := hh.Index()
		num := uint64(len(b.Zond1DataVotes))
		if num > 2048 {
			err = ssz.ErrIncorrectListSize
			return
		}
		for _, elem := range b.Zond1DataVotes {
			if err = elem.HashTreeRootWith(hh); err != nil {
				return
			}
		}
	...
	// Field (10) 'Zond1DepositIndex'
	hh.PutUint64(b.Zond1DepositIndex)
...
func (f *Fork) UnmarshalSSZ(buf []byte) error {
	...
	// Field (2) 'Epoch'
	f.Epoch = github_com_theQRL_qrysm_v4_consensus_types_primitives.Epoch(ssz.UnmarshallUint64(buf[8:16]))
...
func (s *SyncCommittee) UnmarshalSSZ(buf []byte) error {
	...
	for ii := 0; ii < 512; ii++ {
		if cap(s.Pubkeys[ii]) == 0 {
			s.Pubkeys[ii] = make([]byte, 0, len(buf[0:1327104][ii*2592:(ii+1)*2592]))
		}
		s.Pubkeys[ii] = append(s.Pubkeys[ii], buf[0:1327104][ii*2592:(ii+1)*2592]...)
	}
...
func (s *SyncAggregatorSelectionData) UnmarshalSSZ(buf []byte) error {
	...
	// Field (0) 'Slot'
	s.Slot = github_com_theQRL_qrysm_v4_consensus_types_primitives.Slot(ssz.UnmarshallUint64(buf[0:8]))
...
func (s *Status) UnmarshalSSZ(buf []byte) error {
	...
	// Field (2) 'FinalizedEpoch'
	s.FinalizedEpoch = github_com_theQRL_qrysm_v4_consensus_types_primitives.Epoch(ssz.UnmarshallUint64(buf[36:44]))
	...
	// Field (4) 'HeadSlot'
	s.HeadSlot = github_com_theQRL_qrysm_v4_consensus_types_primitives.Slot(ssz.UnmarshallUint64(buf[76:84]))
...
func (b *BeaconBlocksByRangeRequest) UnmarshalSSZ(buf []byte) error {
	...
	// Field (0) 'StartSlot'
	b.StartSlot = github_com_theQRL_qrysm_v4_consensus_types_primitives.Slot(ssz.UnmarshallUint64(buf[0:8]))
...
func (e *ENRForkID) UnmarshalSSZ(buf []byte) error {
	...
	// Field (2) 'NextForkEpoch'
	e.NextForkEpoch = github_com_theQRL_qrysm_v4_consensus_types_primitives.Epoch(ssz.UnmarshallUint64(buf[8:16]))
...
func (s *SyncCommitteeMessage) UnmarshalSSZ(buf []byte) error {
	...
	// Field (2) 'ValidatorIndex'
	s.ValidatorIndex = github_com_theQRL_qrysm_v4_consensus_types_primitives.ValidatorIndex(ssz.UnmarshallUint64(buf[40:48]))

	// Field (3) 'Signature'
	if cap(s.Signature) == 0 {
		s.Signature = make([]byte, 0, len(buf[48:4643]))
	}
	s.Signature = append(s.Signature, buf[48:4643]...)
...
func (s *SyncCommitteeContribution) MarshalSSZTo(buf []byte) (dst []byte, err error) {
	...
	// Field (3) 'ParticipationBits'
	if size := len(s.ParticipationBits); size != 16 {
		err = ssz.ErrBytesLengthFn("--.ParticipationBits", size, 16)
		return
	}
	dst = append(dst, s.ParticipationBits...)

	// Offset (4) 'Signatures'
	dst = ssz.WriteOffset(dst, offset)
	offset += len(s.Signatures) * 4595

	// Offset (5) 'SignaturesIdxToParticipationIdx'
	dst = ssz.WriteOffset(dst, offset)
	offset += len(s.SignaturesIdxToParticipationIdx) * 8

	// Field (4) 'Signatures'
	if size := len(s.Signatures); size > 2048 {
		err = ssz.ErrListTooBigFn("--.Signatures", size, 2048)
		return
	}
	for ii := 0; ii < len(s.Signatures); ii++ {
		if size := len(s.Signatures[ii]); size != 4595 {
			err = ssz.ErrBytesLengthFn("--.Signatures[ii]", size, 4595)
			return
		}
	...
	// Field (5) 'SignaturesIdxToParticipationIdx'
	if size := len(s.SignaturesIdxToParticipationIdx); size > 2048 {
		err = ssz.ErrListTooBigFn("--.SignaturesIdxToParticipationIdx", size, 2048)
		return
	}
	for ii := 0; ii < len(s.SignaturesIdxToParticipationIdx); ii++ {
		dst = ssz.MarshalUint64(dst, s.SignaturesIdxToParticipationIdx[ii])
	}
...
func (s *SyncCommitteeContribution) UnmarshalSSZ(buf []byte) error {
	...
	// Field (3) 'ParticipationBits'
	if cap(s.ParticipationBits) == 0 {
		s.ParticipationBits = make([]byte, 0, len(buf[48:64]))
	}
	s.ParticipationBits = append(s.ParticipationBits, buf[48:64]...)
	...
	// Offset (5) 'SignaturesIdxToParticipationIdx'
	if o5 = ssz.ReadOffset(buf[68:72]); o5 > size || o4 > o5 {
		return ssz.ErrOffset
	}
	...
	// Field (4) 'Signatures'
	{
		...
		for ii := 0; ii < num; ii++ {
			if cap(s.Signatures[ii]) == 0 {
				s.Signatures[ii] = make([]byte, 0, len(buf[ii*4595:(ii+1)*4595]))
			}
			s.Signatures[ii] = append(s.Signatures[ii], buf[ii*4595:(ii+1)*4595]...)
		}
	}
	...
	// Field (5) 'SignaturesIdxToParticipationIdx'
	{
		...
		s.SignaturesIdxToParticipationIdx = ssz.ExtendUint64(s.SignaturesIdxToParticipationIdx, num)
		for ii := 0; ii < num; ii++ {
			s.SignaturesIdxToParticipationIdx[ii] = ssz.UnmarshallUint64(buf[ii*8 : (ii+1)*8])
		}
	}
	return err
}
...
func (s *SyncCommitteeContribution) SizeSSZ() (size int) {
	...
	// Field (4) 'Signatures'
	size += len(s.Signatures) * 4595

	// Field (5) 'SignaturesIdxToParticipationIdx'
	size += len(s.SignaturesIdxToParticipationIdx) * 8
...
func (s *SyncCommitteeContribution) HashTreeRootWith(hh *ssz.Hasher) (err error) {
	...
	hh.PutBytes(s.ParticipationBits)
	...
	// Field (5) 'SignaturesIdxToParticipationIdx'
	{
		...
		subIndx := hh.Index()
		for _, i := range s.SignaturesIdxToParticipationIdx {
			hh.AppendUint64(i)
		}
		hh.FillUpTo32()

		numItems := uint64(len(s.SignaturesIdxToParticipationIdx))
		if ssz.EnableVectorizedHTR {
			hh.MerkleizeWithMixinVectorizedHTR(subIndx, numItems, ssz.CalculateLimit(2048, numItems, 8))
		} else {
			hh.MerkleizeWithMixin(subIndx, numItems, ssz.CalculateLimit(2048, numItems, 8))
...
func (c *ContributionAndProof) MarshalSSZTo(buf []byte) (dst []byte, err error) {
	...
	// Field (2) 'SelectionProof'
	if size := len(c.SelectionProof); size != 4595 {
		err = ssz.ErrBytesLengthFn("--.SelectionProof", size, 4595)
		return
	}
...
func (c *ContributionAndProof) UnmarshalSSZ(buf []byte) error {
	...
	// Field (0) 'AggregatorIndex'
	c.AggregatorIndex = github_com_theQRL_qrysm_v4_consensus_types_primitives.ValidatorIndex(ssz.UnmarshallUint64(buf[0:8]))
	...
	if cap(c.SelectionProof) == 0 {
		c.SelectionProof = make([]byte, 0, len(buf[12:4607]))
	}
	c.SelectionProof = append(c.SelectionProof, buf[12:4607]...)
