...
// Hash: 8e3a350e32099649e1ea44e347066f08c3406963681753e82f75a6bcc6765a8c
package zond
...
func (a *Attestation) MarshalSSZTo(buf []byte) (dst []byte, err error) {
	...
	// Field (2) 'Signatures'
	if size := len(a.Signatures); size > 9410560 {
		err = ssz.ErrBytesLengthFn("--.Signatures", size, 9410560)
		return
	}
	dst = append(dst, a.Signatures...)
...
func (a *Attestation) UnmarshalSSZ(buf []byte) error {
	...
	// Field (2) 'Signatures'
	{
		...
		if cap(a.Signatures) == 0 {
			a.Signatures = make([]byte, 0, len(buf))
		}
		a.Signatures = append(a.Signatures, buf...)
	}
...
func (a *Attestation) HashTreeRootWith(hh *ssz.Hasher) (err error) {
	...
	{
		elemIndx := hh.Index()
		byteLen := uint64(len(a.Signatures))
		if byteLen > 9410560 {
			err = ssz.ErrIncorrectListSize
			return
		}
		hh.PutBytes(a.Signatures)
...
func (i *IndexedAttestation) MarshalSSZTo(buf []byte) (dst []byte, err error) {
	...
	// Field (2) 'Signatures'
	if size := len(i.Signatures); size > 9410560 {
		err = ssz.ErrBytesLengthFn("--.Signatures", size, 9410560)
		return
	}
	dst = append(dst, i.Signatures...)

	// Field (3) 'SignatureValidatorIndex'
	if size := len(i.SignatureValidatorIndex); size > 2048 {
		err = ssz.ErrListTooBigFn("--.SignatureValidatorIndex", size, 2048)
		return
	}
...
func (i *IndexedAttestation) UnmarshalSSZ(buf []byte) error {
	...
	// Field (2) 'Signatures'
	{
		...
		if cap(i.Signatures) == 0 {
			i.Signatures = make([]byte, 0, len(buf))
		}
		i.Signatures = append(i.Signatures, buf...)
	}
...
func (i *IndexedAttestation) HashTreeRootWith(hh *ssz.Hasher) (err error) {
	...
	{
		elemIndx := hh.Index()
		byteLen := uint64(len(i.Signatures))
		if byteLen > 9410560 {
			err = ssz.ErrIncorrectListSize
			return
		}
		hh.PutBytes(i.Signatures)
		if ssz.EnableVectorizedHTR {
			hh.MerkleizeWithMixinVectorizedHTR(elemIndx, byteLen, (9410560+31)/32)
		} else {
			hh.MerkleizeWithMixin(elemIndx, byteLen, (9410560+31)/32)
...
func (s *SyncAggregate) MarshalSSZTo(buf []byte) (dst []byte, err error) {
	...
	if size := len(s.SyncCommitteeSignature); size > 9410560 {
		err = ssz.ErrBytesLengthFn("--.SyncCommitteeSignature", size, 9410560)
		return
	}
...
func (s *SyncCommitteeContribution) MarshalSSZTo(buf []byte) (dst []byte, err error) {
	...
	// Field (4) 'Signature'
	if size := len(s.Signature); size > 9410560 {
