...
// Hash: c5fddcd525ace7248787a1dbce1a5340e9a6cb9e9c88dceccda738c56551ad66
package qrl
...
func (b *BeaconStateCapella) UnmarshalSSZ(buf []byte) error {
	...
	// Field (26) 'NextWithdrawalValidatorIndex'
	b.NextWithdrawalValidatorIndex = github_com_theQRL_qrysm_consensus_types_primitives.ValidatorIndex(ssz.UnmarshallUint64(buf[2254241:2254249]))
...
func (e *QNRForkID) UnmarshalSSZ(buf []byte) error {
	...
	// Field (2) 'NextForkEpoch'
	e.NextForkEpoch = github_com_theQRL_qrysm_consensus_types_primitives.Epoch(ssz.UnmarshallUint64(buf[8:16]))
...
func (v *Validator) UnmarshalSSZ(buf []byte) error {
	...
	// Field (4) 'ActivationEligibilityEpoch'
	v.ActivationEligibilityEpoch = github_com_theQRL_qrysm_consensus_types_primitives.Epoch(ssz.UnmarshallUint64(buf[2633:2641]))

	// Field (5) 'ActivationEpoch'
	v.ActivationEpoch = github_com_theQRL_qrysm_consensus_types_primitives.Epoch(ssz.UnmarshallUint64(buf[2641:2649]))

	// Field (6) 'ExitEpoch'
	v.ExitEpoch = github_com_theQRL_qrysm_consensus_types_primitives.Epoch(ssz.UnmarshallUint64(buf[2649:2657]))

	// Field (7) 'WithdrawableEpoch'
	v.WithdrawableEpoch = github_com_theQRL_qrysm_consensus_types_primitives.Epoch(ssz.UnmarshallUint64(buf[2657:2665]))
...
func (d *DilithiumToExecutionChange) UnmarshalSSZ(buf []byte) error {
	...
	// Field (0) 'ValidatorIndex'
	d.ValidatorIndex = github_com_theQRL_qrysm_consensus_types_primitives.ValidatorIndex(ssz.UnmarshallUint64(buf[0:8]))
