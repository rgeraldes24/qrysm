...
// Hash: 7e442dbe252f69e72ff4014af1d4506dfb684e44851b34c074c599f6157bca97
package qrl
...
func (a *Attestation) MarshalSSZTo(buf []byte) (dst []byte, err error) {
	...
	if size := len(a.AggregationBits); size > 32 {
	...
	// Field (2) 'Signatures'
	if size := len(a.Signatures); size > 32 {
		err = ssz.ErrListTooBigFn("--.Signatures", size, 32)
		return
	}
...
func (a *Attestation) UnmarshalSSZ(buf []byte) error {
	...
	{
		buf = tail[o2:]
		num, err := ssz.DivideInt2(len(buf), 4627, 32)
		if err != nil {
			return err
		}
...
func (a *Attestation) HashTreeRootWith(hh *ssz.Hasher) (err error) {
	...
	hh.PutBitlist(a.AggregationBits, 32)
...
func (a *AggregateAttestationAndProof) UnmarshalSSZ(buf []byte) error {
	...
	// Field (0) 'AggregatorIndex'
	a.AggregatorIndex = ssz.UnmarshallUint[github_com_theQRL_qrysm_consensus_types_primitives.ValidatorIndex](buf[0:8])
...
func (a *AttestationData) UnmarshalSSZ(buf []byte) error {
	...
	// Field (0) 'Slot'
	a.Slot = ssz.UnmarshallUint[github_com_theQRL_qrysm_consensus_types_primitives.Slot](buf[0:8])

	// Field (1) 'CommitteeIndex'
	a.CommitteeIndex = ssz.UnmarshallUint[github_com_theQRL_qrysm_consensus_types_primitives.CommitteeIndex](buf[8:16])
...
func (c *Checkpoint) UnmarshalSSZ(buf []byte) error {
	...
	// Field (0) 'Epoch'
	c.Epoch = ssz.UnmarshallUint[github_com_theQRL_qrysm_consensus_types_primitives.Epoch](buf[0:8])
...
func (d *Deposit) UnmarshalSSZ(buf []byte) error {
	...
	if err = d.Data.UnmarshalSSZ(buf[1056:8379]); err != nil {
		return err
	}
...
func (v *VoluntaryExit) UnmarshalSSZ(buf []byte) error {
	...
	// Field (0) 'Epoch'
	v.Epoch = ssz.UnmarshallUint[github_com_theQRL_qrysm_consensus_types_primitives.Epoch](buf[0:8])

	// Field (1) 'ValidatorIndex'
	v.ValidatorIndex = ssz.UnmarshallUint[github_com_theQRL_qrysm_consensus_types_primitives.ValidatorIndex](buf[8:16])
...
func (b *BeaconBlockHeader) UnmarshalSSZ(buf []byte) error {
	...
	// Field (0) 'Slot'
	b.Slot = ssz.UnmarshallUint[github_com_theQRL_qrysm_consensus_types_primitives.Slot](buf[0:8])

	// Field (1) 'ProposerIndex'
	b.ProposerIndex = ssz.UnmarshallUint[github_com_theQRL_qrysm_consensus_types_primitives.ValidatorIndex](buf[8:16])
...
func (i *IndexedAttestation) MarshalSSZTo(buf []byte) (dst []byte, err error) {
	...
	if size := len(i.AttestingIndices); size > 32 {
		err = ssz.ErrListTooBigFn("--.AttestingIndices", size, 32)
		return
	}
	...
	// Field (2) 'Signatures'
	if size := len(i.Signatures); size > 32 {
		err = ssz.ErrListTooBigFn("--.Signatures", size, 32)
		return
	}
...
func (b *BeaconBlockBodyZond) MarshalSSZTo(buf []byte) (dst []byte, err error) {
	...
	if size := len(b.Attestations); size > 4 {
		err = ssz.ErrListTooBigFn("--.Attestations", size, 4)
		return
	}
	{
...
func (b *BeaconBlockBodyZond) UnmarshalSSZ(buf []byte) error {
	...
	if err = b.ExecutionData.UnmarshalSSZ(buf[32:104]); err != nil {
		return err
	}
	...
	// Offset (9) 'ExecutionPayload'
	if o9 = ssz.ReadOffset(buf[160:164]); o9 > size || o8 > o9 {
		return ssz.ErrOffset
	}
	...
	{
		buf = tail[o6:o7]
		num, err := ssz.DivideInt2(len(buf), 8379, 16)
		if err != nil {
			return err
		}
		...
		for ii := 0; ii < num; ii++ {
			...
			if err = b.Deposits[ii].UnmarshalSSZ(buf[ii*8379 : (ii+1)*8379]); err != nil {
				return err
			}
		}
	}
...
func (v *ValidatorRegistrationV1) UnmarshalSSZ(buf []byte) error {
	...
	// Field (1) 'GasLimit'
	v.GasLimit = ssz.UnmarshallUint[uint64](buf[64:72])

	// Field (2) 'Timestamp'
	v.Timestamp = ssz.UnmarshallUint[uint64](buf[72:80])
...
func (d *Deposit_Data) MarshalSSZTo(buf []byte) (dst []byte, err error) {
	...
	dst = append(dst, d.WithdrawalRecipient...)

	// Field (2) 'Amount'
	dst = ssz.MarshalUint(dst, d.Amount)

	// Field (3) 'RandaoCommitment'
	if size := len(d.RandaoCommitment); size != 32 {
		err = ssz.ErrBytesLengthFn("--.RandaoCommitment", size, 32)
		return
	}
	dst = append(dst, d.RandaoCommitment...)
...
func (d *Deposit_Data) UnmarshalSSZ(buf []byte) error {
	...
	// Field (1) 'WithdrawalRecipient'
	if cap(d.WithdrawalRecipient) == 0 {
		d.WithdrawalRecipient = make([]byte, 0, len(buf[2592:2656]))
	}
	d.WithdrawalRecipient = append(d.WithdrawalRecipient, buf[2592:2656]...)

	// Field (2) 'Amount'
	d.Amount = ssz.UnmarshallUint[uint64](buf[2656:2664])

	// Field (3) 'RandaoCommitment'
	if cap(d.RandaoCommitment) == 0 {
		d.RandaoCommitment = make([]byte, 0, len(buf[2664:2696]))
	}
	d.RandaoCommitment = append(d.RandaoCommitment, buf[2664:2696]...)

	// Field (4) 'Signature'
	if cap(d.Signature) == 0 {
		d.Signature = make([]byte, 0, len(buf[2696:7323]))
	}
	d.Signature = append(d.Signature, buf[2696:7323]...)
...
func (f *Fork) UnmarshalSSZ(buf []byte) error {
	...
	// Field (2) 'Epoch'
	f.Epoch = ssz.UnmarshallUint[github_com_theQRL_qrysm_consensus_types_primitives.Epoch](buf[8:16])
...
func (s *SyncAggregatorSelectionData) UnmarshalSSZ(buf []byte) error {
	...
	// Field (0) 'Slot'
	s.Slot = ssz.UnmarshallUint[github_com_theQRL_qrysm_consensus_types_primitives.Slot](buf[0:8])
...
func (b *BeaconStateZond) MarshalSSZTo(buf []byte) (dst []byte, err error) {
	...
	dst = ssz.MarshalUint(dst, b.ExecutionDepositIndex)

	// Offset (11) 'Validators'
	dst = ssz.WriteOffset(dst, offset)
	offset += len(b.Validators) * 2729
	...
	// Field (14) 'Slashings'
	if size := len(b.Slashings); size != 512 {
		err = ssz.ErrVectorLengthFn("--.Slashings", size, 512)
		return
	}
	for ii := 0; ii < 512; ii++ {
	...
	if size := len(b.ExecutionDataVotes); size > 512 {
		err = ssz.ErrListTooBigFn("--.ExecutionDataVotes", size, 512)
		return
	}
...
func (b *BeaconStateZond) UnmarshalSSZ(buf []byte) error {
	...
	// Field (2) 'Slot'
	b.Slot = ssz.UnmarshallUint[github_com_theQRL_qrysm_consensus_types_primitives.Slot](buf[40:48])
	...
	// Field (10) 'ExecutionDepositIndex'
	b.ExecutionDepositIndex = ssz.UnmarshallUint[uint64](buf[65792:65800])
	...
	// Field (14) 'Slashings'
	b.Slashings = ssz.ExtendUint(b.Slashings, 512)
	for ii := 0; ii < 512; ii++ {
		b.Slashings[ii] = ssz.UnmarshallUint[uint64](buf[2162960:2167056][ii*8 : (ii+1)*8])
	}

	// Offset (15) 'PreviousEpochParticipation'
	if o15 = ssz.ReadOffset(buf[2167056:2167060]); o15 > size || o12 > o15 {
		return ssz.ErrOffset
	}

	// Offset (16) 'CurrentEpochParticipation'
	if o16 = ssz.ReadOffset(buf[2167060:2167064]); o16 > size || o15 > o16 {
		return ssz.ErrOffset
	}

	// Field (17) 'JustificationBits'
	if cap(b.JustificationBits) == 0 {
		b.JustificationBits = make([]byte, 0, len(buf[2167064:2167065]))
	}
	b.JustificationBits = append(b.JustificationBits, buf[2167064:2167065]...)

	// Field (18) 'PreviousJustifiedCheckpoint'
	if b.PreviousJustifiedCheckpoint == nil {
		b.PreviousJustifiedCheckpoint = new(Checkpoint)
	}
	if err = b.PreviousJustifiedCheckpoint.UnmarshalSSZ(buf[2167065:2167105]); err != nil {
		return err
	}
	...
	if err = b.CurrentJustifiedCheckpoint.UnmarshalSSZ(buf[2167105:2167145]); err != nil {
		return err
	}
	...
	if err = b.FinalizedCheckpoint.UnmarshalSSZ(buf[2167145:2167185]); err != nil {
		return err
	}

	// Offset (21) 'InactivityScores'
	if o21 = ssz.ReadOffset(buf[2167185:2167189]); o21 > size || o16 > o21 {
		return ssz.ErrOffset
	}
	...
	if err = b.CurrentSyncCommittee.UnmarshalSSZ(buf[2167189:2498965]); err != nil {
		return err
	}
	...
	if err = b.NextSyncCommittee.UnmarshalSSZ(buf[2498965:2830741]); err != nil {
		return err
	}

	// Offset (24) 'LatestExecutionPayloadHeader'
	if o24 = ssz.ReadOffset(buf[2830741:2830745]); o24 > size || o21 > o24 {
		return ssz.ErrOffset
	}

	// Field (25) 'NextWithdrawalIndex'
	b.NextWithdrawalIndex = ssz.UnmarshallUint[uint64](buf[2830745:2830753])

	// Field (26) 'NextWithdrawalValidatorIndex'
	b.NextWithdrawalValidatorIndex = ssz.UnmarshallUint[github_com_theQRL_qrysm_consensus_types_primitives.ValidatorIndex](buf[2830753:2830761])

	// Offset (27) 'HistoricalSummaries'
	if o27 = ssz.ReadOffset(buf[2830761:2830765]); o27 > size || o24 > o27 {
		return ssz.ErrOffset
	}
	...
	{
		buf = tail[o11:o12]
		num, err := ssz.DivideInt2(len(buf), 2729, 1099511627776)
		if err != nil {
			return err
		}
		...
		for ii := 0; ii < num; ii++ {
			...
			if err = b.Validators[ii].UnmarshalSSZ(buf[ii*2729 : (ii+1)*2729]); err != nil {
				return err
			}
		}
	}
...
func (b *BeaconStateZond) HashTreeRootWith(hh *ssz.Hasher) (err error) {
	...
	// Field (10) 'ExecutionDepositIndex'
	ssz.PutUint(hh, b.ExecutionDepositIndex)
...
func (s *Status) UnmarshalSSZ(buf []byte) error {
	...
	// Field (2) 'FinalizedEpoch'
	s.FinalizedEpoch = ssz.UnmarshallUint[github_com_theQRL_qrysm_consensus_types_primitives.Epoch](buf[36:44])
	...
	// Field (4) 'HeadSlot'
	s.HeadSlot = ssz.UnmarshallUint[github_com_theQRL_qrysm_consensus_types_primitives.Slot](buf[76:84])
...
func (b *BeaconBlocksByRangeRequest) UnmarshalSSZ(buf []byte) error {
	...
	// Field (0) 'StartSlot'
	b.StartSlot = ssz.UnmarshallUint[github_com_theQRL_qrysm_consensus_types_primitives.Slot](buf[0:8])
...
func (q *QNRForkID) MarshalSSZTo(buf []byte) (dst []byte, err error) {
	...
	dst = ssz.MarshalUint(dst, q.NextForkEpoch)
...
func (q *QNRForkID) UnmarshalSSZ(buf []byte) error {
	...
	// Field (2) 'NextForkEpoch'
	q.NextForkEpoch = ssz.UnmarshallUint[github_com_theQRL_qrysm_consensus_types_primitives.Epoch](buf[8:16])
...
func (q *QNRForkID) HashTreeRootWith(hh *ssz.Hasher) (err error) {
	...
	// Field (2) 'NextForkEpoch'
	ssz.PutUint(hh, q.NextForkEpoch)
...
func (s *SyncCommitteeMessage) UnmarshalSSZ(buf []byte) error {
	...
	// Field (2) 'ValidatorIndex'
	s.ValidatorIndex = ssz.UnmarshallUint[github_com_theQRL_qrysm_consensus_types_primitives.ValidatorIndex](buf[40:48])
...
func (c *ContributionAndProof) UnmarshalSSZ(buf []byte) error {
	...
	// Field (0) 'AggregatorIndex'
	c.AggregatorIndex = ssz.UnmarshallUint[github_com_theQRL_qrysm_consensus_types_primitives.ValidatorIndex](buf[0:8])
...
func (v *Validator) MarshalSSZTo(buf []byte) (dst []byte, err error) {
	...
	// Field (1) 'WithdrawalRecipient'
	if size := len(v.WithdrawalRecipient); size != 64 {
		err = ssz.ErrBytesLengthFn("--.WithdrawalRecipient", size, 64)
		return
	}
	dst = append(dst, v.WithdrawalRecipient...)
	...
	// Field (8) 'RandaoCommitment'
	if size := len(v.RandaoCommitment); size != 32 {
		err = ssz.ErrBytesLengthFn("--.RandaoCommitment", size, 32)
		return
	}
	dst = append(dst, v.RandaoCommitment...)
...
func (v *Validator) UnmarshalSSZ(buf []byte) error {
	...
	// Field (1) 'WithdrawalRecipient'
	if cap(v.WithdrawalRecipient) == 0 {
		v.WithdrawalRecipient = make([]byte, 0, len(buf[2592:2656]))
	}
	v.WithdrawalRecipient = append(v.WithdrawalRecipient, buf[2592:2656]...)

	// Field (2) 'EffectiveBalance'
	v.EffectiveBalance = ssz.UnmarshallUint[uint64](buf[2656:2664])

	// Field (3) 'Slashed'
	v.Slashed, err = ssz.DecodeBool(buf[2664:2665])
	if err != nil {
		return err
	}

	// Field (4) 'ActivationEligibilityEpoch'
	v.ActivationEligibilityEpoch = ssz.UnmarshallUint[github_com_theQRL_qrysm_consensus_types_primitives.Epoch](buf[2665:2673])

	// Field (5) 'ActivationEpoch'
	v.ActivationEpoch = ssz.UnmarshallUint[github_com_theQRL_qrysm_consensus_types_primitives.Epoch](buf[2673:2681])

	// Field (6) 'ExitEpoch'
	v.ExitEpoch = ssz.UnmarshallUint[github_com_theQRL_qrysm_consensus_types_primitives.Epoch](buf[2681:2689])

	// Field (7) 'WithdrawableEpoch'
	v.WithdrawableEpoch = ssz.UnmarshallUint[github_com_theQRL_qrysm_consensus_types_primitives.Epoch](buf[2689:2697])

	// Field (8) 'RandaoCommitment'
	if cap(v.RandaoCommitment) == 0 {
		v.RandaoCommitment = make([]byte, 0, len(buf[2697:2729]))
	}
	v.RandaoCommitment = append(v.RandaoCommitment, buf[2697:2729]...)
...
func (v *Validator) HashTreeRootWith(hh *ssz.Hasher) (err error) {
	...
	hh.PutBytes(v.WithdrawalRecipient)
	...
	hh.PutBytes(v.RandaoCommitment)
