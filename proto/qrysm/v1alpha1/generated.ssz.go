...
// Hash: 6ace911803f6115877418c03c84f47ac8aab032a4749684ed0796ff80af2ffdd
package zond
...
func (b *BeaconState) UnmarshalSSZ(buf []byte) error {
	...
	if err = b.CurrentSyncCommittee.UnmarshalSSZ(buf[2687381:5341589]); err != nil {
		return err
	}
	...
	if err = b.NextSyncCommittee.UnmarshalSSZ(buf[5341589:7995797]); err != nil {
		return err
	}

	// Offset (24) 'LatestExecutionPayloadHeader'
	if o24 = ssz.ReadOffset(buf[7995797:7995801]); o24 > size || o21 > o24 {
		return ssz.ErrOffset
	}

	// Field (25) 'NextWithdrawalIndex'
	b.NextWithdrawalIndex = ssz.UnmarshallUint64(buf[7995801:7995809])

	// Field (26) 'NextWithdrawalValidatorIndex'
	b.NextWithdrawalValidatorIndex = github_com_theQRL_qrysm_v4_consensus_types_primitives.ValidatorIndex(ssz.UnmarshallUint64(buf[7995809:7995817]))

	// Offset (27) 'HistoricalSummaries'
	if o27 = ssz.ReadOffset(buf[7995817:7995821]); o27 > size || o24 > o27 {
		return ssz.ErrOffset
	}
...
func (s *SyncCommittee) MarshalSSZTo(buf []byte) (dst []byte, err error) {
	...
	if size := len(s.AggregatePubkey); size != 1327104 {
		err = ssz.ErrBytesLengthFn("--.AggregatePubkey", size, 1327104)
		return
	}
...
func (s *SyncCommittee) UnmarshalSSZ(buf []byte) error {
	...
	if cap(s.AggregatePubkey) == 0 {
		s.AggregatePubkey = make([]byte, 0, len(buf[1327104:2654208]))
	}
	s.AggregatePubkey = append(s.AggregatePubkey, buf[1327104:2654208]...)
