...
// Hash: b2ce9572674dd1b45f47ccc52b7300ea126333357ed89d3c5ba31ddcd9817c25
package zond
...
func (a *Attestation) MarshalSSZTo(buf []byte) (dst []byte, err error) {
	...
	// Offset (2) 'Signature'
	dst = ssz.WriteOffset(dst, offset)
	offset += len(a.Signature)

	// Offset (3) 'SignatureValidatorIndex'
	dst = ssz.WriteOffset(dst, offset)
	offset += len(a.SignatureValidatorIndex) * 8
	...
	// Field (2) 'Signature'
	if size := len(a.Signature); size > 9410560 {
		err = ssz.ErrBytesLengthFn("--.Signature", size, 9410560)
		return
	}
	dst = append(dst, a.Signature...)

	// Field (3) 'SignatureValidatorIndex'
	if size := len(a.SignatureValidatorIndex); size > 2048 {
		err = ssz.ErrListTooBigFn("--.SignatureValidatorIndex", size, 2048)
		return
	}
	for ii := 0; ii < len(a.SignatureValidatorIndex); ii++ {
		dst = ssz.MarshalUint64(dst, a.SignatureValidatorIndex[ii])
	}
...
func (a *Attestation) UnmarshalSSZ(buf []byte) error {
	...
	// Field (2) 'Signature'
	{
		...
		if cap(a.Signature) == 0 {
			a.Signature = make([]byte, 0, len(buf))
		}
		a.Signature = append(a.Signature, buf...)
	}
	...
	// Field (3) 'SignatureValidatorIndex'
	{
		...
		a.SignatureValidatorIndex = ssz.ExtendUint64(a.SignatureValidatorIndex, num)
		for ii := 0; ii < num; ii++ {
			a.SignatureValidatorIndex[ii] = ssz.UnmarshallUint64(buf[ii*8 : (ii+1)*8])
		}
	}
	return err
}
...
func (a *Attestation) SizeSSZ() (size int) {
	...
	// Field (2) 'Signature'
	size += len(a.Signature)

	// Field (3) 'SignatureValidatorIndex'
	size += len(a.SignatureValidatorIndex) * 8
...
func (a *Attestation) HashTreeRootWith(hh *ssz.Hasher) (err error) {
	...
	{
		elemIndx := hh.Index()
		byteLen := uint64(len(a.Signature))
		if byteLen > 9410560 {
		...
		if ssz.EnableVectorizedHTR {
			hh.MerkleizeWithMixinVectorizedHTR(elemIndx, byteLen, (9410560+31)/32)
		} else {
			hh.MerkleizeWithMixin(elemIndx, byteLen, (9410560+31)/32)
		}
	}
	...
	// Field (3) 'SignatureValidatorIndex'
	{
		...
		subIndx := hh.Index()
		for _, i := range a.SignatureValidatorIndex {
			hh.AppendUint64(i)
		}
		hh.FillUpTo32()

		numItems := uint64(len(a.SignatureValidatorIndex))
		if ssz.EnableVectorizedHTR {
...
func (i *IndexedAttestation) MarshalSSZTo(buf []byte) (dst []byte, err error) {
	...
	// Offset (2) 'Signature'
	dst = ssz.WriteOffset(dst, offset)
	offset += len(i.Signature)

	// Offset (3) 'SignatureValidatorIndex'
	dst = ssz.WriteOffset(dst, offset)
	offset += len(i.SignatureValidatorIndex) * 8
	...
	// Field (2) 'Signature'
	if size := len(i.Signature); size > 588160 {
		err = ssz.ErrBytesLengthFn("--.Signature", size, 588160)
		return
	}
	dst = append(dst, i.Signature...)

	// Field (3) 'SignatureValidatorIndex'
	if size := len(i.SignatureValidatorIndex); size > 128 {
		err = ssz.ErrListTooBigFn("--.SignatureValidatorIndex", size, 128)
		return
	}
	for ii := 0; ii < len(i.SignatureValidatorIndex); ii++ {
		dst = ssz.MarshalUint64(dst, i.SignatureValidatorIndex[ii])
	}
...
func (i *IndexedAttestation) UnmarshalSSZ(buf []byte) error {
	...
	// Field (2) 'Signature'
	{
		...
		if cap(i.Signature) == 0 {
			i.Signature = make([]byte, 0, len(buf))
		}
		i.Signature = append(i.Signature, buf...)
	}
	...
	// Field (3) 'SignatureValidatorIndex'
	{
		...
		i.SignatureValidatorIndex = ssz.ExtendUint64(i.SignatureValidatorIndex, num)
		for ii := 0; ii < num; ii++ {
			i.SignatureValidatorIndex[ii] = ssz.UnmarshallUint64(buf[ii*8 : (ii+1)*8])
		}
	}
	return err
}
...
func (i *IndexedAttestation) SizeSSZ() (size int) {
	...
	// Field (2) 'Signature'
	size += len(i.Signature)

	// Field (3) 'SignatureValidatorIndex'
	size += len(i.SignatureValidatorIndex) * 8
...
func (i *IndexedAttestation) HashTreeRootWith(hh *ssz.Hasher) (err error) {
	...
	{
		elemIndx := hh.Index()
		byteLen := uint64(len(i.Signature))
		if byteLen > 588160 {
			err = ssz.ErrIncorrectListSize
			return
		}
		...
		if ssz.EnableVectorizedHTR {
			hh.MerkleizeWithMixinVectorizedHTR(elemIndx, byteLen, (588160+31)/32)
		} else {
			hh.MerkleizeWithMixin(elemIndx, byteLen, (588160+31)/32)
		}
	}
	...
	// Field (3) 'SignatureValidatorIndex'
	{
		...
		subIndx := hh.Index()
		for _, i := range i.SignatureValidatorIndex {
			hh.AppendUint64(i)
		}
		hh.FillUpTo32()

		numItems := uint64(len(i.SignatureValidatorIndex))
		if ssz.EnableVectorizedHTR {
			hh.MerkleizeWithMixinVectorizedHTR(subIndx, numItems, ssz.CalculateLimit(128, numItems, 8))
		} else {
			hh.MerkleizeWithMixin(subIndx, numItems, ssz.CalculateLimit(128, numItems, 8))
...
func (s *SyncAggregate) MarshalSSZTo(buf []byte) (dst []byte, err error) {
	...
	// Offset (1) 'SyncCommitteeSignature'
	dst = ssz.WriteOffset(dst, offset)
	offset += len(s.SyncCommitteeSignature)

	// Field (1) 'SyncCommitteeSignature'
	if size := len(s.SyncCommitteeSignature); size > 73520 {
		err = ssz.ErrBytesLengthFn("--.SyncCommitteeSignature", size, 73520)
		return
	}
...
func (s *SyncAggregate) UnmarshalSSZ(buf []byte) error {
	...
	// Field (1) 'SyncCommitteeSignature'
	{
		...
		if cap(s.SyncCommitteeSignature) == 0 {
			s.SyncCommitteeSignature = make([]byte, 0, len(buf))
		}
		s.SyncCommitteeSignature = append(s.SyncCommitteeSignature, buf...)
	}
	return err
}
...
func (s *SyncAggregate) SizeSSZ() (size int) {
	...
	// Field (1) 'SyncCommitteeSignature'
	size += len(s.SyncCommitteeSignature)
...
func (s *SyncAggregate) HashTreeRootWith(hh *ssz.Hasher) (err error) {
	...
	{
		elemIndx := hh.Index()
		byteLen := uint64(len(s.SyncCommitteeSignature))
		if byteLen > 73520 {
			err = ssz.ErrIncorrectListSize
			return
		}
		...
		if ssz.EnableVectorizedHTR {
			hh.MerkleizeWithMixinVectorizedHTR(elemIndx, byteLen, (73520+31)/32)
		} else {
			hh.MerkleizeWithMixin(elemIndx, byteLen, (73520+31)/32)
		}
	}
...
func (s *SignedBeaconBlockAndBlobsDeneb) UnmarshalSSZ(buf []byte) error {
	...
	{
		buf = tail[o1:]
		num, err := ssz.DivideInt2(len(buf), 135851, 6)
		if err != nil {
			return err
		}
		...
		for ii := 0; ii < num; ii++ {
			...
			if err = s.Blobs[ii].UnmarshalSSZ(buf[ii*135851 : (ii+1)*135851]); err != nil {
				return err
			}
		}
	}
...
func (b *BeaconBlockBodyDeneb) UnmarshalSSZ(buf []byte) error {
	...
	// Offset (11) 'BlobKzgCommitments'
	if o11 = ssz.ReadOffset(buf[4731:4735]); o11 > size || o10 > o11 {
		return ssz.ErrOffset
	}
...
func (b *BeaconState) MarshalSSZTo(buf []byte) (dst []byte, err error) {
	...
	if size := len(b.PreviousEpochAttestations); size > 16384 {
		err = ssz.ErrListTooBigFn("--.PreviousEpochAttestations", size, 16384)
		return
	}
	{
	...
	if size := len(b.CurrentEpochAttestations); size > 16384 {
		err = ssz.ErrListTooBigFn("--.CurrentEpochAttestations", size, 16384)
		return
	}
	{
...
func (b *BeaconState) HashTreeRootWith(hh *ssz.Hasher) (err error) {
	...
	// Field (9) 'ZondDataVotes'
	{
		...
		if ssz.EnableVectorizedHTR {
			hh.MerkleizeWithMixinVectorizedHTR(subIndx, num, 256)
		} else {
	...
	// Field (15) 'PreviousEpochAttestations'
	{
		...
		if ssz.EnableVectorizedHTR {
			hh.MerkleizeWithMixinVectorizedHTR(subIndx, num, 16384)
		} else {
...
func (b *BeaconStateAltair) UnmarshalSSZ(buf []byte) error {
	...
	if err = b.CurrentSyncCommittee.UnmarshalSSZ(buf[2171285:2254229]); err != nil {
		return err
	}
	...
	if err = b.NextSyncCommittee.UnmarshalSSZ(buf[2254229:2337173]); err != nil {
		return err
	}
...
func (p *PendingAttestation) UnmarshalSSZ(buf []byte) error {
	...
	// Field (2) 'InclusionDelay'
	p.InclusionDelay = github_com_theQRL_qrysm_v4_consensus_types_primitives.Slot(ssz.UnmarshallUint64(buf[132:140]))

	// Field (3) 'ProposerIndex'
	p.ProposerIndex = github_com_theQRL_qrysm_v4_consensus_types_primitives.ValidatorIndex(ssz.UnmarshallUint64(buf[140:148]))
...
func (s *SyncCommittee) MarshalSSZTo(buf []byte) (dst []byte, err error) {
	...
	if size := len(s.AggregatePubkey); size != 41472 {
		err = ssz.ErrBytesLengthFn("--.AggregatePubkey", size, 41472)
		return
	}
...
func (s *SyncCommittee) UnmarshalSSZ(buf []byte) error {
	...
	if cap(s.AggregatePubkey) == 0 {
		s.AggregatePubkey = make([]byte, 0, len(buf[41472:82944]))
	}
	s.AggregatePubkey = append(s.AggregatePubkey, buf[41472:82944]...)
...
func (b *BeaconStateBellatrix) UnmarshalSSZ(buf []byte) error {
	...
	// Offset (24) 'LatestExecutionPayloadHeader'
	if o24 = ssz.ReadOffset(buf[2337173:2337177]); o24 > size || o21 > o24 {
		return ssz.ErrOffset
	}
...
func (b *BeaconStateCapella) UnmarshalSSZ(buf []byte) error {
	...
	// Field (25) 'NextWithdrawalIndex'
	b.NextWithdrawalIndex = ssz.UnmarshallUint64(buf[2337177:2337185])

	// Field (26) 'NextWithdrawalValidatorIndex'
	b.NextWithdrawalValidatorIndex = github_com_theQRL_qrysm_v4_consensus_types_primitives.ValidatorIndex(ssz.UnmarshallUint64(buf[2337185:2337193]))

	// Offset (27) 'HistoricalSummaries'
	if o27 = ssz.ReadOffset(buf[2337193:2337197]); o27 > size || o24 > o27 {
		return ssz.ErrOffset
	}
...
func (b *BlobSidecar) UnmarshalSSZ(buf []byte) error {
	...
	// Field (4) 'ProposerIndex'
	b.ProposerIndex = github_com_theQRL_qrysm_v4_consensus_types_primitives.ValidatorIndex(ssz.UnmarshallUint64(buf[80:88]))
...
func (s *SignedBlobSidecar) UnmarshalSSZ(buf []byte) error {
	...
	// Field (1) 'Signature'
	if cap(s.Signature) == 0 {
		s.Signature = make([]byte, 0, len(buf[131256:135851]))
	}
	s.Signature = append(s.Signature, buf[131256:135851]...)
...
func (s *SyncCommitteeContribution) MarshalSSZTo(buf []byte) (dst []byte, err error) {
	...
	if size := len(s.AggregationBits); size != 2 {
		err = ssz.ErrBytesLengthFn("--.AggregationBits", size, 2)
		return
	}
	...
	// Field (4) 'Signature'
	if size := len(s.Signature); size > 73520 {
		err = ssz.ErrBytesLengthFn("--.Signature", size, 73520)
		return
	}
	dst = append(dst, s.Signature...)
