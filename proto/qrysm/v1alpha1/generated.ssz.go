...
// Hash: b740226b42b7a5bb96218680f9ef81806be28d059d04069b772235ad5883137e
package qrl
...
func (i *IndexedAttestation) HashTreeRootWith(hh *ssz.Hasher) (err error) {
	...
	// Field (0) 'AttestingIndices'
	{
		...
		if ssz.EnableVectorizedHTR {
			hh.MerkleizeWithMixinVectorizedHTR(subIndx, numItems, ssz.CalculateLimit(32, numItems, 8))
		} else {
...
func (b *BeaconStateZond) UnmarshalSSZ(buf []byte) error {
	...
	// Field (14) 'Slashings'
	b.Slashings = ssz.ExtendUint64(b.Slashings, 512)
	for ii := 0; ii < 512; ii++ {
		b.Slashings[ii] = ssz.UnmarshallUint64(buf[2162960:2167056][ii*8 : (ii+1)*8])
	}
	...
	// Field (25) 'NextWithdrawalIndex'
	b.NextWithdrawalIndex = ssz.UnmarshallUint64(buf[2830745:2830753])

	// Field (26) 'NextWithdrawalValidatorIndex'
	b.NextWithdrawalValidatorIndex = github_com_theQRL_qrysm_consensus_types_primitives.ValidatorIndex(ssz.UnmarshallUint64(buf[2830753:2830761]))
...
func (b *BeaconStateZond) HashTreeRootWith(hh *ssz.Hasher) (err error) {
	...
	// Field (9) 'ExecutionDataVotes'
	{
		...
		if ssz.EnableVectorizedHTR {
			hh.MerkleizeWithMixinVectorizedHTR(subIndx, num, 512)
		} else {
