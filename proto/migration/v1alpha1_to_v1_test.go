...
func Test_V1Alpha1ToV1SignedBlock(t *testing.T) {
	...
	alphaBlock.Block.Body.ZondData = &zondpbalpha.ZondData{
...
func Test_V1ToV1Alpha1SignedBlock(t *testing.T) {
	...
	v1Block.Block.Body.ZondData = &zondpbv1.ZondData{
		DepositRoot:  depositRoot,
		DepositCount: depositCount,
		BlockHash:    blockHash,
	}
...
func Test_BlockInterfaceToV1Block(t *testing.T) {
	...
	v1Alpha1Block.Block.Body.ZondData = &zondpbalpha.ZondData{
		DepositRoot:  depositRoot,
		DepositCount: depositCount,
		BlockHash:    blockHash,
	}
