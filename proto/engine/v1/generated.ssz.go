...
// Hash: c1f67de5ad8bb15c457c2d35014eca36b432666e4c94adcbcd4d549c24e278d0
package enginev1
...
func (e *ExecutionPayloadCapella) MarshalSSZTo(buf []byte) (dst []byte, err error) {
	...
	if size := len(e.Withdrawals); size > 64 {
		err = ssz.ErrListTooBigFn("--.Withdrawals", size, 64)
		return
	}
...
func (e *ExecutionPayloadCapella) UnmarshalSSZ(buf []byte) error {
	...
	{
		buf = tail[o14:]
		num, err := ssz.DivideInt2(len(buf), 44, 64)
		if err != nil {
			return err
		}
