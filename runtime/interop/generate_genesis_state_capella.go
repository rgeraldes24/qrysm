...
func GenerateGenesisStateCapella(ctx context.Context, genesisTime, numValidators uint64, ep *enginev1.ExecutionPayloadCapella, ed *qrysmpb.ExecutionNodeData) (*qrysmpb.BeaconStateCapella, []*qrysmpb.Deposit, error) {
...
func GenerateGenesisStateCapellaFromDepositData(
	ctx context.Context, genesisTime uint64, depositData []*qrysmpb.Deposit_Data, depositDataRoots [][]byte, ep *enginev1.ExecutionPayloadCapella, e1d *qrysmpb.ExecutionNodeData,
