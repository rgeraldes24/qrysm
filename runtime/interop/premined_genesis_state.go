...
func GeneratePreminedGenesisStateFromDepositData(
	ctx context.Context, genesisTime uint64, depositData []*zondpb.Deposit_Data, depositDataRoots [][]byte, e1d *zondpb.Zond1Data,
	...
	beaconState, err := coreState.PreminedGenesisBeaconState(ctx, deposits, genesisTime, &zondpb.Zond1Data{
		DepositRoot:  root[:],
