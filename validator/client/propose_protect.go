...
func (v *validator) slashableProposalCheck(
	ctx context.Context, pubKey [dilithium.CryptoPublicKeyBytes]byte, signedBlock interfaces.ReadOnlySignedBeaconBlock, signingRoot [32]byte,
) error {
...
func blockLogFields(pubKey [dilithium.CryptoPublicKeyBytes]byte, blk interfaces.ReadOnlyBeaconBlock, sig []byte) logrus.Fields {
