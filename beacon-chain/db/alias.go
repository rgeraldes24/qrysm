...
// ReadOnlyDatabase exposes Qrysm's Ethereum data backend for read access only, no information about
// head info. For head info, use github.com/theQRL/qrysm/blockchain.HeadFetcher.
type ReadOnlyDatabase = iface.ReadOnlyDatabase

// NoHeadAccessDatabase exposes Qrysm's Ethereum data backend for read/write access, no information
...
// Database defines the necessary methods for Qrysm's Ethereum backend which may be implemented by any
