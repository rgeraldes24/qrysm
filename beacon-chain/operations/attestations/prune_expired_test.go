...
func TestPruneExpired_Ticker(t *testing.T) {
	...
	atts := []*zondpb.Attestation{
		{Data: ad1, AggregationBits: bitfield.Bitlist{0b1000, 0b1}, Signature: make([]byte, dilithium.CryptoBytes)},
		{Data: ad2, AggregationBits: bitfield.Bitlist{0b1000, 0b1}, Signature: make([]byte, dilithium.CryptoBytes)},
	}
	...
	atts = []*zondpb.Attestation{
		{Data: ad1, AggregationBits: bitfield.Bitlist{0b1101, 0b1}, Signature: make([]byte, dilithium.CryptoBytes)},
		{Data: ad2, AggregationBits: bitfield.Bitlist{0b1101, 0b1}, Signature: make([]byte, dilithium.CryptoBytes)},
	}
