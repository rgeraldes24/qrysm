...
func TestBatchAttestations_Multiple(t *testing.T) {
	...
	unaggregatedAtts := []*zondpb.Attestation{
		{Data: &zondpb.AttestationData{
			...
			Target:          &zondpb.Checkpoint{Root: mockRoot[:]}}, ParticipationBits: bitfield.Bitlist{0b100100}, Signature: sig.Marshal()},
		{Data: &zondpb.AttestationData{
			Slot:            1,
			BeaconBlockRoot: mockRoot[:],
			Source:          &zondpb.Checkpoint{Root: mockRoot[:]},
			Target:          &zondpb.Checkpoint{Root: mockRoot[:]}}, ParticipationBits: bitfield.Bitlist{0b101000}, Signature: sig.Marshal()},
		{Data: &zondpb.AttestationData{
			Slot:            0,
			BeaconBlockRoot: mockRoot[:],
			Source:          &zondpb.Checkpoint{Root: mockRoot[:]},
			Target:          &zondpb.Checkpoint{Root: mockRoot[:]}}, ParticipationBits: bitfield.Bitlist{0b100010}, Signature: sig.Marshal()},
	}
	aggregatedAtts := []*zondpb.Attestation{
		{Data: &zondpb.AttestationData{
			...
			BeaconBlockRoot: mockRoot[:],
			Source:          &zondpb.Checkpoint{Root: mockRoot[:]},
			Target:          &zondpb.Checkpoint{Root: mockRoot[:]}}, ParticipationBits: bitfield.Bitlist{0b111000}, Signature: sig.Marshal()},
		{Data: &zondpb.AttestationData{
			Slot:            1,
			BeaconBlockRoot: mockRoot[:],
			Source:          &zondpb.Checkpoint{Root: mockRoot[:]},
			Target:          &zondpb.Checkpoint{Root: mockRoot[:]}}, ParticipationBits: bitfield.Bitlist{0b100011}, Signature: sig.Marshal()},
		{Data: &zondpb.AttestationData{
			Slot:            0,
			BeaconBlockRoot: mockRoot[:],
			Source:          &zondpb.Checkpoint{Root: mockRoot[:]},
			Target:          &zondpb.Checkpoint{Root: mockRoot[:]}}, ParticipationBits: bitfield.Bitlist{0b110001}, Signature: sig.Marshal()},
	}
	blockAtts := []*zondpb.Attestation{
		{Data: &zondpb.AttestationData{
			...
			BeaconBlockRoot: mockRoot[:],
			Source:          &zondpb.Checkpoint{Root: mockRoot[:]},
			Target:          &zondpb.Checkpoint{Root: mockRoot[:]}}, ParticipationBits: bitfield.Bitlist{0b100001}, Signature: sig.Marshal()},
		{Data: &zondpb.AttestationData{
			Slot:            1,
			BeaconBlockRoot: mockRoot[:],
			Source:          &zondpb.Checkpoint{Root: mockRoot[:]},
		...
		{Data: &zondpb.AttestationData{
			...
			BeaconBlockRoot: mockRoot[:],
			Source:          &zondpb.Checkpoint{Root: mockRoot[:]},
			Target:          &zondpb.Checkpoint{Root: mockRoot[:]}}, ParticipationBits: bitfield.Bitlist{0b111000}, Signature: sig.Marshal()}, // Duplicated
		{Data: &zondpb.AttestationData{
			Slot:            1,
			BeaconBlockRoot: mockRoot[:],
			Source:          &zondpb.Checkpoint{Root: mockRoot[:]},
			Target:          &zondpb.Checkpoint{Root: mockRoot[:]}}, ParticipationBits: bitfield.Bitlist{0b100011}, Signature: sig.Marshal()}, // Duplicated
	}
...
func TestBatchAttestations_Single(t *testing.T) {
	...
	unaggregatedAtts := []*zondpb.Attestation{
		{Data: d, ParticipationBits: bitfield.Bitlist{0b101000}, Signature: sig.Marshal()},
		{Data: d, ParticipationBits: bitfield.Bitlist{0b100100}, Signature: sig.Marshal()},
	}
	aggregatedAtts := []*zondpb.Attestation{
		{Data: d, ParticipationBits: bitfield.Bitlist{0b101100}, Signature: sig.Marshal()},
		{Data: d, ParticipationBits: bitfield.Bitlist{0b110010}, Signature: sig.Marshal()},
	}
	blockAtts := []*zondpb.Attestation{
		{Data: d, ParticipationBits: bitfield.Bitlist{0b110010}, Signature: sig.Marshal()},
		{Data: d, ParticipationBits: bitfield.Bitlist{0b100010}, Signature: sig.Marshal()},
		{Data: d, ParticipationBits: bitfield.Bitlist{0b110010}, Signature: sig.Marshal()}, // Duplicated
	}
	require.NoError(t, s.cfg.Pool.SaveUnaggregatedAttestations(unaggregatedAtts))
	require.NoError(t, s.cfg.Pool.SaveAggregatedAttestations(aggregatedAtts))
	require.NoError(t, s.cfg.Pool.SaveBlockAttestations(blockAtts))
...
func TestAggregateAndSaveForkChoiceAtts_Single(t *testing.T) {
	...
	atts := []*zondpb.Attestation{
		{Data: d, ParticipationBits: bitfield.Bitlist{0b101}, Signature: sig.Marshal()},
		{Data: d, ParticipationBits: bitfield.Bitlist{0b110}, Signature: sig.Marshal()}}
...
func TestAggregateAndSaveForkChoiceAtts_Multiple(t *testing.T) {
	...
	atts2 := []*zondpb.Attestation{
		{Data: d1, ParticipationBits: bitfield.Bitlist{0b10110}, Signature: sig.Marshal()},
		{Data: d1, ParticipationBits: bitfield.Bitlist{0b11100}, Signature: sig.Marshal()},
		{Data: d1, ParticipationBits: bitfield.Bitlist{0b11000}, Signature: sig.Marshal()},
	}
	require.NoError(t, s.aggregateAndSaveForkChoiceAtts(atts2))
	att3 := []*zondpb.Attestation{
		{Data: d2, ParticipationBits: bitfield.Bitlist{0b1100}, Signature: sig.Marshal()},
	}
...
func TestSeenAttestations_PresentInCache(t *testing.T) {
	...
	att1 := &zondpb.Attestation{Data: ad1, Signature: []byte{'A'}, ParticipationBits: bitfield.Bitlist{0x13} /* 0b00010011 */}
	got, err := s.seen(att1)
	require.NoError(t, err)
	assert.Equal(t, false, got)

	att2 := &zondpb.Attestation{Data: ad1, Signature: []byte{'A'}, ParticipationBits: bitfield.Bitlist{0x17} /* 0b00010111 */}
	got, err = s.seen(att2)
	require.NoError(t, err)
	assert.Equal(t, false, got)

	att3 := &zondpb.Attestation{Data: ad1, Signature: []byte{'A'}, ParticipationBits: bitfield.Bitlist{0x17} /* 0b00010111 */}
	got, err = s.seen(att3)
	require.NoError(t, err)
