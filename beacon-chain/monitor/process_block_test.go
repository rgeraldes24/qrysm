...
<<<<<<< HEAD
	wanted1 := fmt.Sprintf("\"Proposed beacon block was included\" BalanceChange=100000000 BlockRoot=%#x NewBalance=40000000000000 ParentRoot=0xb88dfbae9294 ProposerIndex=51 Slot=1 Version=0 prefix=monitor", bytesutil.Trunc(root[:]))
=======
	wanted1 := fmt.Sprintf("\"Proposed beacon block was included\" BalanceChange=100000000 BlockRoot=%#x NewBalance=40000000000000 ParentRoot=0x87c8b84caef1 ProposerIndex=51 Slot=1 Version=0 prefix=monitor", bytesutil.Trunc(root[:]))
>>>>>>> main
