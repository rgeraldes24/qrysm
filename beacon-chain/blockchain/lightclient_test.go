...
func (l *testlc) setupTest() *testlc {
	...
	attestedState, err := util.NewBeaconState()
...
func (l *testlc) checkAttestedHeader(update *zondpbv1.LightClientUpdate) {
...
func (l *testlc) checkSyncAggregate(update *zondpbv1.LightClientUpdate) {
