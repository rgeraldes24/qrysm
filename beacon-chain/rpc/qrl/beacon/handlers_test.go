...
func TestServer_GetBlockHeader(t *testing.T) {
	...
	t.Run("ok", func(t *testing.T) {
		...
		assert.Equal(t, "0xba129cc6809b9f98ef8166925742b5e747c602ed8536f528e75f1646b26f3f0b", resp.Data.Root)
		...
		assert.Equal(t, "0xb3a1259426e9bd9d5d568ceb06602230e7c7e61870a9407cd1f11eaf1651f249", resp.Data.Header.Message.BodyRoot)
