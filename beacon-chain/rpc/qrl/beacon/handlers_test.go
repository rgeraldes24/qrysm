...
func TestServer_GetBlockHeader(t *testing.T) {
	...
	t.Run("ok", func(t *testing.T) {
		...
		assert.Equal(t, "0x0af048b4980f47586d33c0d27fd0e8f1a901c0469c7211c6c169241270839476", resp.Data.Root)
		...
		assert.Equal(t, "0x67178f8f2f5d87e403e7f416be5aafa64e5450d05bd7dc7dc4e4cdb2a7c8f13a", resp.Data.Header.Message.BodyRoot)
...
func TestGetDepositContract(t *testing.T) {
	...
	config.DepositContractAddress = "Q42424242424242424242424242424242424242424242424242424242424242424242424242424242424242424242424242424242424242424242424242424242"
	params.OverrideBeaconConfig(config)
	...
	assert.Equal(t, "Q42424242424242424242424242424242424242424242424242424242424242424242424242424242424242424242424242424242424242424242424242424242", response.Data.Address)
}
