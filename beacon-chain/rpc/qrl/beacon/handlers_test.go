...
func TestServer_GetBlockHeader(t *testing.T) {
	...
	t.Run("ok", func(t *testing.T) {
		...
		assert.Equal(t, "0x47094c504cb8085b673a622e0f4bda83ae81132568e007c335dedc911c51ff66", resp.Data.Root)
		...
		assert.Equal(t, "0xe6925bb382b32eff8cad5d611881ed9c0869bb60c4d466aa660857c7bb5af335", resp.Data.Header.Message.BodyRoot)
...
func TestGetDepositContract(t *testing.T) {
	...
	assert.Equal(t, "Q4242424242424242424242424242424242424242", response.Data.Address)
}
