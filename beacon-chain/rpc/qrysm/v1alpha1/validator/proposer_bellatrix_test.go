		...
		t.Run("Can get builder payload and blobs in Deneb", func(t *testing.T) {
			...
			bid := &zondpb.BuilderBidDeneb{
				...
				BlindedBlobsBundle: &v1.BlindedBlobsBundle{
					KzgCommitments: [][]byte{bytesutil.PadTo([]byte{1}, dilithium2.CryptoPublicKeyBytes), bytesutil.PadTo([]byte{4}, dilithium2.CryptoPublicKeyBytes)},
					Proofs:         [][]byte{bytesutil.PadTo([]byte{2}, dilithium2.CryptoPublicKeyBytes), bytesutil.PadTo([]byte{5}, dilithium2.CryptoPublicKeyBytes)},
