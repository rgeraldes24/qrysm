						...
						Attestations: []*zondpb.Attestation{
							{
								...
								AggregationBits: bitfield.Bitlist{0b11},
								Signature:       bytesutil.PadTo([]byte("sig"), dilithium.CryptoBytes),
							},
						},
					},
				},
		...
		blockExample.Block.Body.Attestations = []*zondpb.Attestation{
			{
				...
				Signature:       bytesutil.PadTo([]byte("root"), dilithium.CryptoBytes),
				AggregationBits: bitfield.Bitlist{0b11},
			},
		}
		util.SaveBlock(t, ctx, db, blockExample)
	...
	atts := []*zondpb.Attestation{
		{
			...
			Signature:       bytesutil.PadTo([]byte{1}, dilithium.CryptoBytes),
		},
		{
			Data: &zondpb.AttestationData{
				Slot:            2,
			...
			AggregationBits: bitfield.Bitlist{0b1101},
			Signature:       bytesutil.PadTo([]byte{2}, dilithium.CryptoBytes),
		},
		{
			Data: &zondpb.AttestationData{
				Slot:            3,
			...
			AggregationBits: bitfield.Bitlist{0b1101},
			Signature:       bytesutil.PadTo([]byte{3}, dilithium.CryptoBytes),
		},
	}
