...
import (
	...
	validator2 "github.com/theQRL/qrysm/v4/consensus-types/validator"
...
func (s *Server) GetSyncCommitteeDuties(w http.ResponseWriter, r *http.Request) {
	...
	committeePubkeys := make(map[[dilithium.CryptoPublicKeyBytes]byte][]string)
...
func syncCommitteeDuties(
	...
	committeePubkeys map[[dilithium.CryptoPublicKeyBytes]byte][]string,
