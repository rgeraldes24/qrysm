...
func TestGetAggregateAttestation(t *testing.T) {
	...
	sig1 := bytesutil.PadTo([]byte("sig1"), dilithiumlib.CryptoBytes)
	...
	sig21 := bytesutil.PadTo([]byte("sig2_1"), dilithiumlib.CryptoBytes)
	...
	sig22 := bytesutil.PadTo([]byte("sig2_2"), dilithiumlib.CryptoBytes)
...
func TestGetAggregateAttestation_SameSlotAndRoot_ReturnMostAggregationBits(t *testing.T) {
	...
	sig := bytesutil.PadTo([]byte("sig"), dilithiumlib.CryptoBytes)
