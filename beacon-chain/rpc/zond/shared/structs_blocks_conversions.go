...
func (b *BeaconBlockCapella) ToConsensus() (*zond.BeaconBlockCapella, error) {
	...
	payloadFeeRecipient, err := DecodeAddressHexWithLength(b.Body.ExecutionPayload.FeeRecipient, fieldparams.FeeRecipientLength)
	if err != nil {
	...
	for i, w := range b.Body.ExecutionPayload.Withdrawals {
		...
		address, err := DecodeAddressHexWithLength(w.ExecutionAddress, common.AddressLength)
		if err != nil {
...
func (b *BlindedBeaconBlockCapella) ToConsensus() (*zond.BlindedBeaconBlockCapella, error) {
	...
	payloadFeeRecipient, err := DecodeAddressHexWithLength(b.Body.ExecutionPayloadHeader.FeeRecipient, fieldparams.FeeRecipientLength)
	if err != nil {
...
func DilithiumChangesToConsensus(src []*SignedDilithiumToExecutionChange) ([]*zond.SignedDilithiumToExecutionChange, error) {
	...
	for i, ch := range src {
		...
		address, err := DecodeAddressHexWithLength(ch.Message.ToExecutionAddress, common.AddressLength)
		if err != nil {
