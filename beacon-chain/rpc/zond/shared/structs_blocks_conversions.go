...
func (b *SignedBeaconBlock) ToGeneric() (*zond.GenericSignedBeaconBlock, error) {
	...
	sig, err := DecodeHexWithLength(b.Signature, dilithium.CryptoBytes)
	if err != nil {
...
func (b *BeaconBlock) ToConsensus() (*zond.BeaconBlock, error) {
	...
	randaoReveal, err := DecodeHexWithLength(b.Body.RandaoReveal, dilithium.CryptoBytes)
	if err != nil {
...
func (b *BeaconBlockAltair) ToConsensus() (*zond.BeaconBlockAltair, error) {
	...
	syncCommitteeSig, err := DecodeHexWithLength(b.Body.SyncAggregate.SyncCommitteeSignature, dilithium.CryptoBytes)
	if err != nil {
...
func (b *BeaconBlockDeneb) ToConsensus() (*zond.BeaconBlockDeneb, error) {
	...
	for i, b := range b.Body.BlobKzgCommitments {
		kzg, err := DecodeHexWithLength(b, dilithium.CryptoPublicKeyBytes)
		if err != nil {
...
func (s *BlobSidecar) ToConsensus() (*zond.BlobSidecar, error) {
	...
	kzgCommitment, err := DecodeHexWithLength(s.KzgCommitment, dilithium.CryptoPublicKeyBytes)
	if err != nil {
		return nil, NewDecodeError(err, "KzgCommitment")
	}
	kzgProof, err := DecodeHexWithLength(s.KzgProof, dilithium.CryptoPublicKeyBytes)
	if err != nil {
...
func (s *SignedBlobSidecar) ToConsensus() (*zond.SignedBlobSidecar, error) {
	...
	blobSig, err := DecodeHexWithLength(s.Signature, dilithium.CryptoBytes)
	if err != nil {
		return nil, NewDecodeError(err, "Signature")
	}
	...
	kzgCommitment, err := DecodeHexWithLength(s.Message.KzgCommitment, dilithium.CryptoPublicKeyBytes)
	if err != nil {
		return nil, NewDecodeError(err, "Message.KzgCommitment")
	}
	kzgProof, err := DecodeHexWithLength(s.Message.KzgProof, dilithium.CryptoPublicKeyBytes)
	if err != nil {
...
func ProposerSlashingsToConsensus(src []*ProposerSlashing) ([]*zond.ProposerSlashing, error) {
	...
	for i, s := range src {
		...
		h1Sig, err := DecodeHexWithLength(s.SignedHeader1.Signature, dilithium.CryptoBytes)
		if err != nil {
		...
		h2Sig, err := DecodeHexWithLength(s.SignedHeader2.Signature, dilithium.CryptoBytes)
		if err != nil {
...
func AttesterSlashingsToConsensus(src []*AttesterSlashing) ([]*zond.AttesterSlashing, error) {
	...
	for i, s := range src {
		...
		a1Sig, err := DecodeHexWithLength(s.Attestation1.Signature, dilithium.CryptoBytes)
		if err != nil {
		...
		a2Sig, err := DecodeHexWithLength(s.Attestation2.Signature, dilithium.CryptoBytes)
		if err != nil {
...
func DepositsToConsensus(src []*Deposit) ([]*zond.Deposit, error) {
	...
	for i, d := range src {
		...
		pubkey, err := DecodeHexWithLength(d.Data.Pubkey, dilithium.CryptoPublicKeyBytes)
		if err != nil {
		...
		sig, err := DecodeHexWithLength(d.Data.Signature, dilithium.CryptoBytes)
		if err != nil {
...
func DilithiumChangesToConsensus(src []*SignedDilithiumToExecutionChange) ([]*zond.SignedDilithiumToExecutionChange, error) {
	...
	for i, ch := range src {
		...
		sig, err := DecodeHexWithLength(ch.Signature, dilithium.CryptoBytes)
		if err != nil {
			return nil, NewDecodeError(err, fmt.Sprintf("[%d].Signature", i))
		}
		...
		pubkey, err := DecodeHexWithLength(ch.Message.FromDilithiumPubkey, dilithium.CryptoPublicKeyBytes)
		if err != nil {
