...
func TestUpgradeToBellatrix(t *testing.T) {
	...
	require.DeepSSZEqual(t, preForkState.ZondData(), mSt.ZondData())
	require.DeepSSZEqual(t, preForkState.ZondDataVotes(), mSt.ZondDataVotes())
	require.DeepSSZEqual(t, preForkState.ZondDepositIndex(), mSt.ZondDepositIndex())
