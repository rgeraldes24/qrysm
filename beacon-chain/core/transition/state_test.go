...
func TestGenesisBeaconState_OK(t *testing.T) {
	...
	require.NoError(t, err)
	assert.DeepEqual(t, zond1Data.BlockHash, mix, "RandaoMixes was not correctly initialized")
	...
	// Deposit root checks.
	assert.DeepEqual(t, zond1Data.DepositRoot, newState.Zond1Data().DepositRoot, "Zond1Data DepositRoot was not correctly initialized")
	assert.DeepSSZEqual(t, []*zondpb.Zond1Data{}, newState.Zond1DataVotes(), "Zond1DataVotes was not correctly initialized")
}
