...
func TestUpgradeToAltair(t *testing.T) {
	...
	require.DeepSSZEqual(t, preForkState.Zond1Data(), aState.Zond1Data())
	require.DeepSSZEqual(t, preForkState.Zond1DataVotes(), aState.Zond1DataVotes())
	require.DeepSSZEqual(t, preForkState.Zond1DepositIndex(), aState.Zond1DepositIndex())
