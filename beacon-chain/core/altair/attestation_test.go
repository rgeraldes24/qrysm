...
func TestProcessAttestations_InclusionDelayFailure(t *testing.T) {
	...
	b.Block = &zondpb.BeaconBlockAltair{
	...
	_, err = altair.ProcessAttestationsNoVerifySignatures(context.Background(), beaconState, wsb)
...
func TestFuzzProcessAttestationsNoVerify_10000(t *testing.T) {
	...
	b := &zondpb.SignedBeaconBlockAltair{Block: &zondpb.BeaconBlockAltair{}}
	for i := 0; i < 10000; i++ {
		fuzzer.Fuzz(st)
		fuzzer.Fuzz(b)
		if b.Block == nil {
		...
		wsb, err := blocks.NewSignedBeaconBlock(b)
		require.NoError(t, err)
		r, err := altair.ProcessAttestationsNoVerifySignatures(context.Background(), s, wsb)
		if err != nil && r != nil {
