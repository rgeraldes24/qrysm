...
func TestUpgradeToCapella(t *testing.T) {
	...
	require.DeepSSZEqual(t, preForkState.Zond1Data(), mSt.Zond1Data())
	require.DeepSSZEqual(t, preForkState.Zond1DataVotes(), mSt.Zond1DataVotes())
	require.DeepSSZEqual(t, preForkState.Zond1DepositIndex(), mSt.Zond1DepositIndex())
