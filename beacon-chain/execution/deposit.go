...
func (s *Service) processDeposit(ctx context.Context, zond1Data *zondpb.Zond1Data, deposit *zondpb.Deposit) error {
	var err error
	if err := s.preGenesisState.SetZond1Data(zond1Data); err != nil {
		return err
	}
