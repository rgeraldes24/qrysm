...
func (s *Service) processDeposit(ctx context.Context, zondData *zondpb.ZondData, deposit *zondpb.Deposit) error {
	var err error
	if err := s.preGenesisState.SetZondData(zondData); err != nil {
		return err
	}
