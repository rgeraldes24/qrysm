...
func FuzzExecutionPayload(f *testing.F) {
	...
	execData := &engine.ExecutionPayloadEnvelope{
		ExecutionPayload: &engine.ExecutableData{
			...
			FeeRecipient:  common.BytesToAddress([]byte{0xFF, 0x01, 0xFF, 0x01, 0xFF, 0x01, 0xFF, 0x01, 0xFF, 0xFF, 0x01, 0xFF, 0x01, 0xFF, 0x01, 0xFF, 0x01, 0xFF}),
...
func FuzzExecutionBlock(f *testing.F) {
	...
	logsBloom := [256]byte{'j', 'u', 'n', 'k'}
	addr := common.BytesToAddress(common.Hex2Bytes("095e7baea6a6c7c4c2dfeb977efac326af552d87"))
