...
func (s *Service) NewPayload(ctx context.Context, payload interfaces.ExecutionData, versionedHashes []common.Hash, parentBlockRoot *common.Hash) ([]byte, error) {
	ctx, span := trace.StartSpan(ctx, "executionChain.engine-api-client.NewPayload")
	defer span.End()
	start := time.Now()
	defer func() {
...
func (s *Service) ForkchoiceUpdated(
	...
	ctx, span := trace.StartSpan(ctx, "executionChain.engine-api-client.ForkchoiceUpdated")
	defer span.End()
	start := time.Now()
	defer func() {
...
func (s *Service) GetPayload(ctx context.Context, payloadId [8]byte, slot primitives.Slot) (interfaces.ExecutionData, bool, error) {
	ctx, span := trace.StartSpan(ctx, "executionChain.engine-api-client.GetPayload")
	defer span.End()
	start := time.Now()
	defer func() {
...
func (s *Service) LatestExecutionBlock(ctx context.Context) (*pb.ExecutionBlock, error) {
	ctx, span := trace.StartSpan(ctx, "executionChain.engine-api-client.LatestExecutionBlock")
	defer span.End()
...
func (s *Service) ExecutionBlockByHash(ctx context.Context, hash common.Hash, withTxs bool) (*pb.ExecutionBlock, error) {
	ctx, span := trace.StartSpan(ctx, "executionChain.engine-api-client.ExecutionBlockByHash")
	defer span.End()
	result := &pb.ExecutionBlock{}
...
func (s *Service) GetPayloadBodiesByHash(ctx context.Context, executionBlockHashes []common.Hash) ([]*pb.ExecutionPayloadBodyV1, error) {
	ctx, span := trace.StartSpan(ctx, "executionChain.engine-api-client.GetPayloadBodiesByHashV1")
	defer span.End()
...
func (s *Service) GetPayloadBodiesByRange(ctx context.Context, start, count uint64) ([]*pb.ExecutionPayloadBodyV1, error) {
	ctx, span := trace.StartSpan(ctx, "executionChain.engine-api-client.GetPayloadBodiesByRangeV1")
	defer span.End()
