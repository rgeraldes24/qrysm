...
type CommonStats struct {
	...
	SyncZond2FallbackConfigured bool `json:"sync_zond2_fallback_configured"`
	...
	SyncZond2FallbackConnected bool `json:"sync_zond2_fallback_connected"`
...
type BeaconNodeStats struct {
	...
	SyncZond1Connected        bool  `json:"sync_zond1_connected"`
	SyncZond2Synced           bool  `json:"sync_zond2_synced"`
