...
// DeterministicZond1Data takes an array of deposits and returns the zond1Data made from the deposit trie.
func DeterministicZond1Data(size int) (*zondpb.Zond1Data, error) {
