...
func DeterministicGenesisStateBellatrix(t testing.TB, numValidators uint64) (state.BeaconState, []bls.SecretKey) {
	...
	beaconState, err := genesisBeaconStateBellatrix(context.Background(), deposits, uint64(0), zond1Data)
	if err != nil {
...
func genesisBeaconStateBellatrix(ctx context.Context, deposits []*zondpb.Deposit, genesisTime uint64, zond1Data *zondpb.Zond1Data) (state.BeaconState, error) {
	...
	return buildGenesisBeaconStateBellatrix(genesisTime, st, st.Zond1Data())
}
...
func buildGenesisBeaconStateBellatrix(genesisTime uint64, preState state.BeaconState, zond1Data *zondpb.Zond1Data) (state.BeaconState, error) {
	if zond1Data == nil {
