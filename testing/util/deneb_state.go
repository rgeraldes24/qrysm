...
func genesisBeaconStateDeneb(ctx context.Context, deposits []*zondpb.Deposit, genesisTime uint64, eth1Data *zondpb.Eth1Data) (state.BeaconState, error) {
...
func buildGenesisBeaconStateDeneb(genesisTime uint64, preState state.BeaconState, eth1Data *zondpb.Eth1Data) (state.BeaconState, error) {
	if eth1Data == nil {
	...
	bodyRoot, err := (&zondpb.BeaconBlockBodyDeneb{
