...
// Source: github.com/theQRL/qrysm/v4/proto/qrysm/v1alpha1 (interfaces: BeaconNodeValidatorClient,BeaconNodeValidator_WaitForChainStartClient,BeaconNodeValidator_WaitForActivationClient,BeaconNodeValidator_StreamDutiesClient)
...
// Recv mocks base method.
func (m *MockBeaconNodeValidator_StreamDutiesClient) Recv() (*zond.DutiesResponse, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Recv")
	ret0, _ := ret[0].(*zond.DutiesResponse)
	ret1, _ := ret[1].(error)
