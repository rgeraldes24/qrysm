...
// Source: github.com/theQRL/qrysm/v4/proto/qrysm/v1alpha1 (interfaces: BeaconNodeValidatorServer,BeaconNodeValidator_WaitForActivationServer,BeaconNodeValidator_WaitForChainStartServer,BeaconNodeValidator_StreamDutiesServer)
...
// Send mocks base method.
func (m *MockBeaconNodeValidator_StreamDutiesServer) Send(arg0 *zond.DutiesResponse) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Send", arg0)
	ret0, _ := ret[0].(error)
	return ret0
