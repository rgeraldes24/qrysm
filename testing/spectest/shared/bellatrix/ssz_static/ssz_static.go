...
func customHtr(t *testing.T, htrs []common.HTR, object interface{}) []common.HTR {
	...
	case *zondpb.BeaconStateBellatrix:
		htrs = append(htrs, func(s interface{}) ([32]byte, error) {
			beaconState, err := state_native.InitializeFromProtoBellatrix(s.(*zondpb.BeaconStateBellatrix))
...
func unmarshalledSSZ(t *testing.T, serializedBytes []byte, folderName string) (interface{}, error) {
	...
	case "BeaconBlock":
		obj = &zondpb.BeaconBlockBellatrix{}
	case "BeaconBlockBody":
		obj = &zondpb.BeaconBlockBodyBellatrix{}
	case "BeaconBlockHeader":
		obj = &zondpb.BeaconBlockHeader{}
	case "BeaconState":
		obj = &zondpb.BeaconStateBellatrix{}
	case "Checkpoint":
	...
	case "SignedBeaconBlock":
		obj = &zondpb.SignedBeaconBlockBellatrix{}
