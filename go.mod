...
require (
	...
	github.com/rgeraldes24/tx-fuzz v0.0.0-20231103123916-ca527a183bae
...
replace github.com/theQRL/go-zond => github.com/rgeraldes24/go-zond v0.0.0-20231107110758-b16b5dd04c42
